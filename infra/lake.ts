...
const tableBucketName = `bolt-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `bolt-${$app.stage}-lake-ingest`,
    destination: "iceberg",
