...
1. Add `@bolt-ai/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@bolt-ai/effect-drizzle-sqlite` as a dependency of `packages/opencode`.
