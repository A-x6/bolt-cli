...
- Preserve technical terms and artifacts exactly: Bolt, API names, identifiers, code, commands, flags, paths, URLs, versions, error messages, config keys, and placeholder tokens.
