...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@bolt-ai/sdk/v2"
    ...
    ...pipe(
      ...
      map((provider) => ({
        ...
        description: {
          ...
          "bolt-go": "Low cost subscription for everyone",
        }[provider.id],
    ...
    <DialogPrompt
      ...
      onConfirm={async (value) => {
        ...
        if (props.custom && !sync.data.provider_next.all.some((provider) => provider.id === props.providerID)) {
          toast.show({
            variant: "info",
            message: `Saved credential for ${props.providerID}. Configure it in bolt.json to use it.`,
          })
          dialog.clear()
          return
        }
