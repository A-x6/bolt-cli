...
export const TypeId: TypeId = "~@bolt-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@bolt-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@bolt-ai/effect-sqlite-node/NodeSqliteClient")
