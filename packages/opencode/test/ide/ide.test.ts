...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BOLT_CALLER", () => {
    process.env["BOLT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BOLT_CALLER", () => {
    process.env["BOLT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BOLT_CALLER", () => {
    process.env["BOLT_CALLER"] = "unknown"
