...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bolt.git")).toEqual({ owner: "sst", repo: "bolt" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opencode")).toEqual({ owner: "sst", repo: "bolt" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bolt.git")).toEqual({ owner: "sst", repo: "bolt" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opencode")).toEqual({ owner: "sst", repo: "bolt" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bolt.git")).toEqual({ owner: "sst", repo: "bolt" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opencode")).toEqual({ owner: "sst", repo: "bolt" })
})
