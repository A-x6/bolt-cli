 ...
 *   "@bolt/ServerAuthConfig",
 *   {
 *     password: Config.string("BOLT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BOLT_SERVER_USERNAME").pipe(Config.withDefault("bolt")),
 *   },
 * ) {}
 *
