...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@bolt/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@bolt/ACPDirectory") {}
