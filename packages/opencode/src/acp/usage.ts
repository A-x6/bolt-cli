...
import type { AssistantMessage as BoltAssistantMessage, Message } from "@bolt-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@bolt-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<BoltAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<BoltAssistantMessage, "role"> &
  Partial<Pick<BoltAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@bolt/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@bolt/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@bolt/ACPUsage") {}
