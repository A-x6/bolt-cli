...
import type * as SDK from "@bolt-ai/sdk/v2"
...
import { SessionShareTable } from "@bolt-ai/core/share/sql"
import { ProviderV2 } from "@bolt-ai/core/provider"
import { ModelV2 } from "@bolt-ai/core/model"
import { EventV2 } from "@bolt-ai/core/event"

const disabled = process.env["BOLT_DISABLE_SHARE"] === "true" || process.env["BOLT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/ShareNext") {}
