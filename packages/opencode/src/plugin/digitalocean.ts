import type { Hooks, PluginInput } from "@bolt-ai/plugin"
import type { Model } from "@bolt-ai/sdk/v2"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Bolt will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
