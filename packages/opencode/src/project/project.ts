...
import { ProjectDirectoryTable, ProjectTable } from "@bolt-ai/core/project/sql"
import { ProjectDirectories } from "@bolt-ai/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.BOLT_FAKE_VCS)
