...
import { AbsolutePath, type DeepMutable } from "@bolt-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/Agent") {}
