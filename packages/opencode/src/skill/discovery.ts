...
import { httpClient, path } from "@bolt-ai/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/SkillDiscovery") {}
      ...
      const dirs = yield* Effect.forEach(
        ...
        (skill) =>
          Effect.gen(function* () {
            ...
            const versionFile = path.join(root, ".bolt-version")
            ...
            if (version === undefined || current === version) {
              ...
              yield* Effect.gen(function* () {
                ...
                yield* fs.writeFileString(path.join(staging, ".bolt-version"), version)
