...
>()("@bolt/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@bolt/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.BOLT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.BOLT_WORKSPACE_ID) : undefined
}
