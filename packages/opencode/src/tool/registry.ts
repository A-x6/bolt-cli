...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@bolt-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/ToolRegistry") {}
