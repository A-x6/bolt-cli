...
import { EventSequenceTable, EventTable } from "@bolt-ai/core/event/sql"
...
import { WorkspaceEvent } from "@bolt-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        BOLT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        BOLT_WORKSPACE_ID: config.id,
        BOLT_EXPERIMENTAL_WORKSPACES: "true",
