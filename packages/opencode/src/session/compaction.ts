...
import { buildPrompt } from "@bolt-ai/core/session/compaction"
import { SessionPin } from "./pin"
import { SessionCompactionEvent } from "@bolt-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/SessionCompaction") {}
