...
import type { Event, GlobalEvent, OpencodeClient } from "@bolt-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@bolt/RunStreamTransport") {}
