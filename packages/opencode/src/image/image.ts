...
export class Service extends Context.Service<Service, Interface>()("@bolt/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __BOLT_PHOTON_WASM_PATH?: string }).__BOLT_PHOTON_WASM_PATH =
