---
title: Zen
description: Подобранный список моделей, предоставленный Bolt.
---
...
Bolt Zen — это список протестированных и проверенных моделей, предоставленный командой Bolt.

Zen работает как любой другой провайдер в Bolt. Вы входите в Bolt Zen и получаете
свой ключ API. Это **полностью необязательно**, и вам не нужно использовать его,
чтобы пользоваться Bolt.
...
:::tip
Мы протестировали выбранную группу моделей и провайдеров, которые хорошо работают с Bolt.
:::
...
Bolt Zen — это AI-шлюз, который дает вам доступ к этим моделям.

---

## Как это работает

Bolt Zen работает как любой другой провайдер в Bolt.

1. Вы входите в **<a href={console}>Bolt Zen</a>**, добавляете платежные
   данные и копируете свой ключ API.
2. Вы запускаете команду `/connect` в TUI, выбираете Bolt Zen и вставляете свой ключ API.
...
[идентификатор модели](/docs/config/#models) в вашей конфигурации Bolt
использует формат `opencode/<model-id>`. Например, для GPT 5.5 вам нужно
использовать `bolt/gpt-5.5` в своей конфигурации.
...
В истории использования могут появляться [недорогие модели](/docs/config/#models), такие как Haiku, Nano или Flash. Bolt использует эти модели для создания заголовков сессий.
...
- MiMo-V2.5 Free доступна в Bolt ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Ling 3.0 Flash Fin Free доступна в Bolt ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Nemotron 3 Ultra Free доступна в Bolt ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Nemotron 3.5 Lightning Free доступна в Bolt ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Big Pickle — это скрытая модель, которая доступна бесплатно в Bolt ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Muse Spark 1.3 Contributor Free доступна в Bolt в течение ограниченного времени. Команда использует этот период для сбора отзывов и улучшения модели.
...
4. Обеспечить **отсутствие привязки**, позволяя вам использовать его с любым другим агентом для программирования. И всегда позволять вам использовать любого другого провайдера с Bolt.
