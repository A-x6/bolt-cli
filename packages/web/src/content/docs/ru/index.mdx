---
title: Введение
description: Начните работу с bolt.
---
...
Для наилучшей работы в Windows мы рекомендуем использовать [Подсистема Windows для Linux (WSL)](/docs/windows-wsl). Он обеспечивает лучшую производительность и полную совместимость с функциями bolt.
:::
...
Если вы новичок в использовании поставщиков LLM, мы рекомендуем использовать [Bolt Zen](/docs/zen).
Это тщательно подобранный список моделей, протестированных и проверенных bolt.

1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [bolt.ai/auth](https://bolt.ai/auth).
...
Разговорами, которые вы ведете с bolt, можно [поделиться с вашей
командой](/docs/share).
...
Вот [пример диалога](https://bolt.ai/s/4XP1fce5) с bolt.

---

## Настроить

И все! Теперь вы профессионал в использовании bolt.
