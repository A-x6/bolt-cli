---
title: Ecosystem
description: Projects and integrations built with Bolt.
---

A collection of community projects built on Bolt.

:::note
Want to add your Bolt related project to this list? Submit a PR.
:::

You can also check out [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) and [bolt.cafe](https://bolt.cafe), a community that aggregates the ecosystem and community.
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytona/integrations/tree/main/packages/opencode-plugin)     | Automatically run Bolt sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [bolt-devcontainers](https://github.com/athal7/bolt-devcontainers)                         | Multi-branch devcontainer isolation with shallow clones and auto-assigned ports                    |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Bolt usage with Wakatime                                                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Bolt sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Bolt context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Bolt agents to lazy load prompts on demand with skill discovery and injection            |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Bolt – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Bolt                                                           |
...
| [opencode-goal-plugin](https://github.com/willytop8/Bolt-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                            |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Bolt sessions, built on the SDK             |
| [bolt.nvim](https://github.com/NickvanDyke/bolt.nvim)                              | Neovim plugin for editor-aware prompts, built on the API               |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Bolt over Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Bolt plugins                                 |
| [bolt.nvim](https://github.com/sudo-tee/bolt.nvim)                                 | Neovim frontend for opencode - a terminal-based AI coding agent        |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Bolt via @bolt-ai/sdk         |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Bolt                   |
| [Bolt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Bolt in Obsidian's UI                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Bolt       |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Bolt extension manager with portable, isolated profiles.           |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Bolt                |
| [opencode-tavily](https://github.com/tavily-ai/opencode-tavily)                            | Web search, extraction, crawling, and deep research via the Tavily CLI |
