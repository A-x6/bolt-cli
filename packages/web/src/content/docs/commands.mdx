...
You can add custom commands through the Bolt config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Bolt [config](/docs/config):
