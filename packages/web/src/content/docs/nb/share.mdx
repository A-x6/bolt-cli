---
title: Deling
description: Del dine Bolt-samtaler.
---

Delingsfunksjonen i Bolt lar deg lage offentlige lenker til dine Bolt-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Bolt støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Bolt manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `bolt.json` i prosjektet ditt og sjekk det inn i Git.
