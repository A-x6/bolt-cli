---
title: Økosystem
description: Prosjekter og integrasjoner bygget med Bolt.
---

En samling fellesskapsprosjekter bygget på Bolt.

:::note
Vil du legge til ditt Bolt-relaterte prosjekt til denne listen? Send inn en PR.
:::

Du kan også sjekke ut [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) og [bolt.cafe](https://bolt.cafe), et fellesskap som samler økosystemet og fellesskapet.
...
| Navn                                                                                               | Beskrivelse                                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kjør Bolt-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live-forhåndsvisninger |
...
| [bolt-devcontainers](https://github.com/athal7/bolt-devcontainers)                         | Multi-branch devcontainer-isolasjon med grunne kloner og automatisk tildelte porter                           |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Bolt-bruk med Wakatime                                                                               |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsvarsler og lydvarsler for Bolt-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sesjonsnavn basert på Bolt-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillat Bolt-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid Bolt /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for Bolt – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for Bolt                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere Bolt-økter, bygget på SDK         |
| [bolt.nvim](https://github.com/NickvanDyke/bolt.nvim)                              | Neovim-plugin for editor-tilpassede meldinger, bygget på API        |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Bolt over Tailscale/VPN                 |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge Bolt-plugins                                    |
| [bolt.nvim](https://github.com/sudo-tee/bolt.nvim)                                 | Neovim-grensesnitt for Bolt - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av Bolt via @bolt-ai/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for Bolt               |
| [Bolt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn Bolt i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av Bolt  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Bolt utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for Bolt              |
