...
description: Lag verktøy som LLM kan kalle inn Bolt.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Bolt sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.bolt/tools/`-katalogen til prosjektet ditt.
