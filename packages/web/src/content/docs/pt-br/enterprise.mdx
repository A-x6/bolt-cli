...
Se um usuário habilitar o recurso `/share`, a conversa e os dados associados a ela são enviados para o serviço que usamos para hospedar essas páginas de compartilhamento em bolt.ai.
...
**Você possui todo o código produzido pelo bolt.** Não há restrições de licenciamento ou reivindicações de propriedade.
...
Basta começar com um teste interno com sua equipe. O bolt, por padrão, não armazena seu código ou dados de contexto, facilitando o início.
...
O opencode suporta registros npm privados através do suporte nativo do arquivo `.npmrc` do Bun. Se sua organização usa um registro privado, como JFrog Artifactory, Nexus ou similar, certifique-se de que os desenvolvedores estejam autenticados antes de executar o bolt.
...
:::caution
Você deve estar logado no registro privado antes de executar o bolt.
:::
