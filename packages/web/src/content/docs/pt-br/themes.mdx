...
Com o bolt, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.
...
3. **Diretório raiz do projeto** - Definido em `<project-root>/.bolt/themes/*.json`
4. **Diretório de trabalho atual** - Definido em `./.bolt/themes/*.json`
