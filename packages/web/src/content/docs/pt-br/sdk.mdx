---
title: SDK
description: Cliente JS seguro em tipos para o servidor bolt.
---
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `bolt.json`, mas você pode substituir ou adicionar configuração inline:
