---
title: Introdução
description: Comece a usar o bolt.
---
...
Para a melhor experiência no Windows, recomendamos usar o [Windows Subsystem for Linux (WSL)](/docs/windows-wsl). Ele oferece melhor desempenho e total compatibilidade com os recursos do bolt.
:::
...
Com o bolt, você pode usar qualquer provedor de LLM configurando suas chaves de API.

Se você é novo no uso de provedores de LLM, recomendamos usar o [Bolt Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do bolt.

1. Execute o comando `/connect` no TUI, selecione opencode e acesse [bolt.ai/auth](https://bolt.ai/auth).
...
Aqui está uma [conversa de exemplo](https://bolt.ai/s/4XP1fce5) com o bolt.

---

## Personalização

E é isso! Agora você é um profissional em usar o bolt.
