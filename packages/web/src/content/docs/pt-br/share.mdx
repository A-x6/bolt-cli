---
title: Compartilhar
description: Compartilhe suas conversas do bolt.
---

O recurso de compartilhamento do opencode permite que você crie links públicos para suas conversas do bolt, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `bolt.json` em seu projeto e faça o check-in no Git.
