---
title: Zen
description: Liste organisée de modèles fournis par Bolt.
---
...
Bolt Zen est une liste de modèles testés et vérifiés fournie par l'équipe Bolt.

Zen fonctionne comme n'importe quel autre fournisseur dans Bolt. Vous vous connectez à Bolt Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Bolt.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Bolt.
:::
...
Bolt Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Bolt Zen fonctionne comme n'importe quel autre fournisseur dans Bolt.

1. Vous vous connectez à **<a href={console}>Bolt Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Bolt Zen et collez votre clé API.
...
| ------------------------------- | ------------------------------- | --------------------------------------------------------- | --------------------------- |
| GPT 6 Astra                     | gpt-6-astra                     | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.6 Sol                     | gpt-5.6-sol                     | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.6 Terra                   | gpt-5.6-terra                   | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.6 Luna                    | gpt-5.6-luna                    | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.5                         | gpt-5.5                         | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.5 Pro                     | gpt-5.5-pro                     | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.4                         | gpt-5.4                         | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.4 Pro                     | gpt-5.4-pro                     | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.4 Mini                    | gpt-5.4-mini                    | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.4 Nano                    | gpt-5.4-nano                    | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.3 Codex                   | gpt-5.3-codex                   | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark             | gpt-5.3-codex-spark             | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.2                         | gpt-5.2                         | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.2 Codex                   | gpt-5.2-codex                   | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.1                         | gpt-5.1                         | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.1 Codex                   | gpt-5.1-codex                   | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max               | gpt-5.1-codex-max               | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini              | gpt-5.1-codex-mini              | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5                           | gpt-5                           | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5 Codex                     | gpt-5-codex                     | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| GPT 5 Nano                      | gpt-5-nano                      | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| Claude Fable 5.1                | claude-fable-5-1                | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Fable 5                  | claude-fable-5                  | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Opus 5                   | claude-opus-5                   | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Opus 4.8                 | claude-opus-4-8                 | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Opus 4.7                 | claude-opus-4-7                 | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Opus 4.6                 | claude-opus-4-6                 | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Opus 4.5                 | claude-opus-4-5                 | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Sonnet 5                 | claude-sonnet-5                 | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6               | claude-sonnet-4-6               | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5               | claude-sonnet-4-5               | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5                | claude-haiku-4-5                | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Gemini 3.8 Flash                | gemini-3.8-flash                | `https://bolt.ai/zen/v1/models/gemini-3.8-flash`      | `@ai-sdk/google`            |
| Gemini 3.7 Flash                | gemini-3.7-flash                | `https://bolt.ai/zen/v1/models/gemini-3.7-flash`      | `@ai-sdk/google`            |
| Gemini 3.6 Flash                | gemini-3.6-flash                | `https://bolt.ai/zen/v1/models/gemini-3.6-flash`      | `@ai-sdk/google`            |
| Gemini 3.5 Flash                | gemini-3.5-flash                | `https://bolt.ai/zen/v1/models/gemini-3.5-flash`      | `@ai-sdk/google`            |
| Gemini 3.5 Flash Lite           | gemini-3.5-flash-lite           | `https://bolt.ai/zen/v1/models/gemini-3.5-flash-lite` | `@ai-sdk/google`            |
| Gemini 3.1 Pro                  | gemini-3.1-pro                  | `https://bolt.ai/zen/v1/models/gemini-3.1-pro`        | `@ai-sdk/google`            |
| Gemini 3 Flash                  | gemini-3-flash                  | `https://bolt.ai/zen/v1/models/gemini-3-flash`        | `@ai-sdk/google`            |
| Grok 4.6                        | grok-4.6                        | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| Grok 4.5                        | grok-4.5                        | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| Grok Build 0.1                  | grok-build-0.1                  | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| Muse Spark 1.3                  | muse-spark-1.3                  | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| Muse Spark 1.2                  | muse-spark-1.2                  | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |
| Qwen3.7 Max                     | qwen3.7-max                     | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus                    | qwen3.7-plus                    | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus                    | qwen3.6-plus                    | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| Qwen3.5 Plus                    | qwen3.5-plus                    | `https://bolt.ai/zen/v1/messages`                     | `@ai-sdk/anthropic`         |
| DeepSeek V4 Pro                 | deepseek-v4-pro                 | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash               | deepseek-v4-flash               | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Vision Exp    | deepseek-v4-flash-vision-exp    | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| MiniMax M3                      | minimax-m3                      | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| MiniMax M2.7                    | minimax-m2.7                    | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| MiniMax M2.5                    | minimax-m2.5                    | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| GLM 5.3 Flash                   | glm-5.3-flash                   | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| GLM 5.3                         | glm-5.3                         | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| GLM 5.2                         | glm-5.2                         | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| GLM 5.1                         | glm-5.1                         | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| GLM 5                           | glm-5                           | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Kimi K2.5                       | kimi-k2.5                       | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Kimi K2.6                       | kimi-k2.6                       | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Kimi K2.7 Code                  | kimi-k2.7-code                  | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Kimi K3                         | kimi-k3                         | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Big Pickle                      | big-pickle                      | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| MiMo-V2.5 Free                  | mimo-v2.5-free                  | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Ling 3.0 Flash Fin Free         | ling-3.0-flash-fin-free         | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Nemotron 3 Ultra Free           | nemotron-3-ultra-free           | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Nemotron 3.5 Lightning Free     | nemotron-3.5-lightning-free     | `https://bolt.ai/zen/v1/chat/completions`             | `@ai-sdk/openai-compatible` |
| Muse Spark 1.3 Contributor Free | muse-spark-1.3-contributor-free | `https://bolt.ai/zen/v1/responses`                    | `@ai-sdk/openai`            |

Le [model id](/docs/config/#models) dans votre configuration Bolt utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `bolt/gpt-5.5` dans votre configuration.
...
Vous remarquerez peut-être des [modèles à faible coût](/docs/config/#models), tels que Haiku, Nano ou Flash, dans votre historique d'utilisation. Bolt utilise ces modèles pour générer les titres des sessions.
...
- MiMo-V2.5 Free est disponible sur Bolt pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Ling 3.0 Flash Fin Free est disponible sur Bolt pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur Bolt pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3.5 Lightning Free est disponible sur Bolt pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Bolt pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Muse Spark 1.3 Contributor Free est disponible sur Bolt pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Bolt également.
