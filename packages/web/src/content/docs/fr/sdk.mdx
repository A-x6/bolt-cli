---
title: SDK
description: Client JS de type sécurisé pour le serveur bolt.
---
...
Vous pouvez transmettre un objet de configuration pour personnaliser le comportement. L'instance récupère toujours votre `bolt.json`, mais vous pouvez remplacer ou ajouter une configuration en ligne :
...
Si vous disposez déjà d'une instance en cours d'exécution de bolt, vous pouvez créer une instance client pour vous y connecter :
