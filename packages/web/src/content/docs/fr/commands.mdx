...
Vous pouvez ajouter des commandes personnalisées via la configuration Bolt ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Bolt [config](/docs/config) :
