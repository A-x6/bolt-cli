...
Avec Bolt, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, Bolt utilise notre propre thème `opencode`.
...
Bolt est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que Bolt corresponde à l'apparence de leur terminal
...
Bolt prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
...
3. **Répertoire racine du projet** - Défini dans `<project-root>/.bolt/themes/*.json`
4. **Répertoire de travail actuel** - Défini dans `./.bolt/themes/*.json`
...
{
  "$schema": "https://bolt.ai/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
