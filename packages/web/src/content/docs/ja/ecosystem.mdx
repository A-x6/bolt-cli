---
title: エコシステム
description: Bolt で構築されたプロジェクトと統合。
---

Bolt に基づいて構築されたコミュニティプロジェクトのコレクション。

:::note
Bolt 関連プロジェクトをこのリストに追加したいですか? PR を送信してください。
:::

[awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) および [bolt.cafe](https://bolt.cafe) もチェックしてください。
...
| 名前                                                                                               | 説明                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync とライブプレビューを使用して、隔離された Daytona サンドボックスで Bolt セッションを自動的に実行します。 |
...
| [bolt-devcontainers](https://github.com/athal7/bolt-devcontainers)                         | 浅いクローンと自動割り当てポートを使用したマルチブランチ devcontainer の分離                                         |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | wakatime で Bolt の使用状況を追跡する                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Bolt セッションのデスクトップ通知とサウンドアラート                                                              |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 許可、完了、エラーイベントのデスクトップ通知とサウンドアラート                                                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Bolt コンテキストに基づいた AI による自動 Zellij セッション命名                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Bolt エージェントがスキルの検出と挿入を使用してオンデマンドでプロンプトを遅延ロードできるようにする              |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Bolt/コマンドをきめ細かいフロー制御を備えた強力なオーケストレーションシステムに拡張                              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Bolt のネイティブ OS 通知 – タスクがいつ完了したかを知る                                                         |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | バンドルされたマルチエージェントオーケストレーションハーネス – 16 コンポーネント、1 回のインストール                 |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bolt 用のゼロフリクション Git ワークツリー                                                                       |
...
| 名前                                                                                       | 説明                                                                             |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 上に構築された Bolt セッションを制御する Discord ボット                  |
| [bolt.nvim](https://github.com/NickvanDyke/bolt.nvim)                              | API に基づいて構築された、エディター対応プロンプト用の Neovim プラグイン         |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 上の Bolt 向けモバイルファースト Web UI                        |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Bolt プラグインを構築するためのテンプレート                                  |
| [bolt.nvim](https://github.com/sudo-tee/bolt.nvim)                                 | Neovim Bolt用フロントエンド - ターミナルベースの AI コーディングエージェント |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @bolt-ai/sdk 経由で Bolt を使用するための Vercel AI SDK プロバイダー     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Bolt 用の Web/デスクトップアプリと VS Code 拡張機能                          |
| [Bolt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian の UI に Bolt を埋め込む Obsidian プラグイン                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Bolt を利用した、Claude Cowork に代わるオープンソース                        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 移植可能な独立したプロファイルを備えた Bolt 拡張機能マネージャー。           |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Bolt 用のデスクトップ、Web、モバイル、およびリモートクライアントアプリ       |
