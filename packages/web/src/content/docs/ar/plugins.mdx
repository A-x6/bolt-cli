---
title: الإضافات
description: اكتب إضافاتك الخاصة لتوسيع Bolt.
---

تتيح لك الإضافات توسيع Bolt عبر ربطها بأحداث مختلفة وتخصيص السلوك. يمكنك إنشاء إضافات لإضافة ميزات جديدة، أو التكامل مع خدمات خارجية، أو تعديل السلوك الافتراضي لـ Bolt.
...
- `.bolt/plugins/` - إضافات على مستوى المشروع
...
1. إعدادات عامة (`~/.config/opencode/bolt.json`)
2. إعدادات المشروع (`bolt.json`)
3. دليل الإضافات العام (`~/.config/opencode/plugins/`)
4. دليل إضافات المشروع (`.bolt/plugins/`)
...
يشغّل Bolt الأمر `bun install` عند بدء التشغيل لتثبيتها. بعد ذلك يمكن لإضافاتك وأدواتك استيرادها.
...
فيما يلي بعض أمثلة الإضافات التي يمكنك استخدامها لتوسيع bolt.
...
:::note
إذا كنت تستخدم تطبيق Bolt لسطح المكتب، فيمكنه إرسال إشعارات النظام تلقائيا عند جاهزية الرد أو عند حدوث خطأ في جلسة.
:::
...
المستويات: `debug`, `info`, `warn`, `error`. راجع [توثيق SDK](https://bolt.ai/docs/sdk) للتفاصيل.
