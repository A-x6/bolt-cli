---
title: TUI
description: استخدام واجهة المستخدم TUI في Bolt.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Bolt واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Bolt إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Bolt في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Bolt. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Bolt. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `bolt.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Bolt بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `bolt.default`.
