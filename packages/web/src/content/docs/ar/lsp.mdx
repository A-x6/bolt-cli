---
title: خوادم LSP
description: يتكامل Bolt مع خوادم LSP لديك.
---

يمكن أن يتكامل Bolt مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Bolt مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `BOLT_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات bolt.
