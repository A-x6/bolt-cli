...
مع Bolt يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Bolt سمتنا `opencode`.
...
- يريدون أن يطابق Bolt مظهر terminal لديهم
...
يدعم Bolt نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.bolt/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.bolt/themes/*.json`
