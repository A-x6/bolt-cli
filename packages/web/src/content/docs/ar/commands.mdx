...
أنشئ الملف `.bolt/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات Bolt أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Bolt:
