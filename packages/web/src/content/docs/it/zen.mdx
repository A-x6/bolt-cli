---
title: Zen
description: Lista curata di modelli fornita da Bolt.
---
...
Bolt Zen è un elenco di modelli testati e verificati forniti dal team di Bolt.

Zen funziona come qualsiasi altro provider in Bolt. Accedi a Bolt Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Bolt.
:::
...
Bolt Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Bolt Zen funziona come qualsiasi altro provider in Bolt.

1. Accedi a **<a href={console}>Bolt Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Bolt Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Bolt
usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.5, useresti
`bolt/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Bolt usa questi modelli per generare i titoli delle sessioni.
...
- MiMo-V2.5 Free è disponibile su Bolt per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling 3.0 Flash Fin Free è disponibile su Bolt per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Bolt per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3.5 Lightning Free è disponibile su Bolt per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Bolt per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Muse Spark 1.3 Contributor Free è disponibile su Bolt per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Bolt.
