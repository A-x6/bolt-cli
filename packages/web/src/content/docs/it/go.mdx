...
Bolt Go è un abbonamento a basso costo da **10 $/mese** che ti offre un accesso affidabile ai popolari modelli di programmazione aperti.

Go funziona come qualsiasi altro provider in Bolt. Ti abboni a Bolt Go e
...
Bolt Go ti dà accesso a questi modelli a **10 $/mese**.

---

## Come funziona

Bolt Go funziona come qualsiasi altro provider in Bolt.

1. Accedi a **<a href={console}>Bolt Zen</a>**, ti abboni a Go e
   copi la tua chiave API.
2. Esegui il comando `/connect` nella TUI, selezioni `Bolt Go` e incolli
   la tua chiave API.
3. Esegui `/models` nella TUI per vedere l'elenco dei modelli disponibili tramite Go.

:::note
Solo un membro per workspace può abbonarsi a Bolt Go.
:::
...
Bolt Go è progettato per [Bolt](https://bolt.ai) e altri agenti di programmazione
...
Oltre a Bolt, è stato verificato che i seguenti client funzionino correttamente
con Bolt Go. Tuttavia, non garantiamo che continueranno a funzionare in futuro.

| Client            | Supporto delle sessioni                                                                                                                                                                                                                                                      |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Le build contenenti la [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) inviano l'header nelle richieste Bolt principali e ausiliarie. La correzione è stata unita dopo la v0.21.0; quella versione da sola non la include.                        |
...
| **Pi**            | Le build attuali inviano le informazioni di sessione per Bolt. Aggiorna le installazioni meno recenti.                                                                                                                                                                   |
...
| **Kilo Code CLI** | Le build contenenti la [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) ripristinano gli header di sessione Bolt. Questa correzione riguarda la CLI, non l'estensione VS Code. Consulta l'[issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
Il [model id](/docs/config/#models) nella tua Bolt config
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con Bolt.
