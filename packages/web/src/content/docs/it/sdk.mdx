---
title: SDK
description: Client JS type-safe per il server bolt.
---
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `bolt.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
