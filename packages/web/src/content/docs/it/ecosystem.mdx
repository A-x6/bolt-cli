---
title: Ecosistema
description: Progetti e integrazioni costruiti con Bolt.
---

Una raccolta di progetti della comunità costruiti su Bolt.

:::note
Vuoi aggiungere il tuo progetto legato a Bolt a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) e [bolt.cafe](https://bolt.cafe), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni Bolt in sandbox Daytona isolate con sync git e anteprime live |
...
| [bolt-devcontainers](https://github.com/athal7/bolt-devcontainers)                         | Isolamento devcontainer multi-branch con shallow clone e porte assegnate automaticamente          |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di Bolt con Wakatime                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni Bolt                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto Bolt                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti Bolt di caricare prompt al bisogno con discovery e injection di skill    |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per Bolt: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per Bolt                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Bolt, costruito sull'SDK    |
| [bolt.nvim](https://github.com/NickvanDyke/bolt.nvim)                              | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Bolt su Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Bolt                               |
| [bolt.nvim](https://github.com/sudo-tee/bolt.nvim)                                 | Frontend Neovim per opencode: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Bolt tramite @bolt-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Bolt                   |
| [Bolt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Bolt nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Bolt      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Bolt con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Bolt                |
