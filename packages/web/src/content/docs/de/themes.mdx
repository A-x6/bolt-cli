...
Mit Bolt kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Bolt das `opencode`-Theme.
...
Bolt liefert mehrere eingebaute Themes mit.
...
- Bolt optisch ans Terminal anpassen wollen
...
Bolt unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.bolt/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.bolt/themes/*.json`
