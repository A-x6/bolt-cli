...
Erstellen Sie `.bolt/commands/test.md`:

```md title=".bolt/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Bolt-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Bolt [config](/docs/config):

```json title="bolt.jsonc" {4-12}
{
...
```md title=".bolt/commands/component.md"
---
...
```md title=".bolt/commands/create-file.md"
---
...
```md title=".bolt/commands/analyze-coverage.md"
---
...
```md title=".bolt/commands/review-changes.md"
---
...
```md title=".bolt/commands/review-component.md"
---
...
Bolt enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
