---
title: Zen
description: Kuratierte Modellliste direkt von Bolt.
---
...
Bolt Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Bolt-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Bolt. Du meldest dich bei Bolt Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Bolt zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Bolt funktionieren.
:::
...
Bolt Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Bolt Zen funktioniert wie jeder andere Provider in Bolt.

1. Du meldest dich bei **<a href={console}>Bolt Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Bolt Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Bolt-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `bolt/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Bolt verwendet diese Modelle, um Session-Titel zu generieren.
...
- MiMo-V2.5 Free ist für begrenzte Zeit auf Bolt verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ling 3.0 Flash Fin Free ist für begrenzte Zeit auf Bolt verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Bolt verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf Bolt verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Bolt verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Muse Spark 1.3 Contributor Free ist für begrenzte Zeit auf Bolt verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Bolt Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Bolt auch jeden anderen Provider zu verwenden.
