...
description: Erstellen Sie Tools, die der LLM in Bolt aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von Bolt wie `read`, `write` und `bash`.
...
- Lokal, indem Sie sie im Verzeichnis `.bolt/tools/` Ihres Projekts platzieren.
