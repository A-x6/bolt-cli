---
title: Teilen
description: Teile Bolt-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Bolt-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Bolt Folgendes:
...
Bolt hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Bolt den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`bolt.json` fest und committe die Datei.
