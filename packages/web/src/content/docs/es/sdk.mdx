---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor bolt.
---
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `bolt.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de bolt, puede crear una instancia de cliente para conectarse a ella:
