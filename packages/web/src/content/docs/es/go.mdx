...
Bolt Go es una suscripción de bajo costo de **$10/mes** que te brinda acceso confiable a modelos abiertos de programación populares.

Go funciona como cualquier otro proveedor en Bolt. Te suscribes a Bolt Go y
...
Bolt Go te da acceso a estos modelos por **$10/mes**.

---

## Cómo funciona

Bolt Go funciona como cualquier otro proveedor en Bolt.

1. Inicias sesión en **<a href={console}>Bolt Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `Bolt Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a Bolt Go.
:::
...
Bolt Go está diseñado para [Bolt](https://bolt.ai) y otros agentes de programación
...
Además de Bolt, se ha validado que los siguientes clientes funcionan correctamente
con Bolt Go. Sin embargo, no garantizamos que sigan funcionando en el futuro.

| Cliente           | Compatibilidad con sesiones                                                                                                                                                                                                                                                              |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Las compilaciones que incluyen el [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) envían el encabezado en las peticiones principales y auxiliares de Bolt. La corrección se fusionó después de v0.21.0; esa versión por sí sola no la incluye.                |
...
| **Pi**            | Las compilaciones actuales envían información de sesión para Bolt. Actualiza las instalaciones antiguas.                                                                                                                                                                             |
...
| **Kilo Code CLI** | Las compilaciones que incluyen el [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) restauran los encabezados de sesión de Bolt. Esta corrección cubre la CLI, no la extensión de VS Code. Consulta el [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
El [ID del modelo](/docs/config/#models) en tu configuración de Bolt
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con Bolt.
