---
title: Zen
description: Lista seleccionada de modelos proporcionada por Bolt.
---
...
Bolt Zen es una lista de modelos probados y verificados proporcionada por el equipo de Bolt.

Zen funciona como cualquier otro proveedor en Bolt. Inicias sesión en Bolt Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Bolt.
:::
...
Bolt Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Bolt Zen funciona como cualquier otro proveedor en Bolt.

1. Inicias sesión en **<a href={console}>Bolt Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Bolt Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Bolt
usa el formato `opencode/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`bolt/gpt-5.5` en tu configuración.
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Bolt usa estos modelos para generar títulos de sesiones.
...
- MiMo-V2.5 Free está disponible en Bolt por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ling 3.0 Flash Fin Free está disponible en Bolt por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Bolt por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3.5 Lightning Free está disponible en Bolt por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Bolt por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Muse Spark 1.3 Contributor Free está disponible en Bolt por tiempo limitado. El equipo está aprovechando este período para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Bolt.
