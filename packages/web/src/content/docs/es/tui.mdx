---
title: TUI
description: Usando la interfaz de usuario del terminal Bolt.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Bolt proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Bolt se inicia TUI para el directorio actual.
...
Cuando utilice Bolt TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Bolt. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `bolt.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Bolt después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `bolt.default`.
