...
Con Bolt puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Bolt usa nuestro propio tema `opencode`.
...
Bolt viene con varios temas integrados.
...
- Quiere que Bolt coincida con la apariencia de su terminal
...
Bolt admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
3. **Directorio raíz del proyecto**: definido en `<project-root>/.bolt/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.bolt/themes/*.json`
