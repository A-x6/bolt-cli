---
title: Compartir
description: Comparte tus conversaciones Bolt.
---

La función para compartir de Bolt te permite crear enlaces públicos a tus conversaciones de Bolt, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Bolt:
...
Bolt admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Bolt usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `bolt.json` en su proyecto y regístrelo en Git.
