...
Bolt Go คือการสมัครสมาชิกในราคาประหยัด **$10/เดือน** ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร

Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน Bolt คุณสามารถสมัครสมาชิก Bolt Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน Bolt
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่คัดเลือกมาเพื่อให้ทำงานร่วมกับ Bolt ได้เป็นอย่างดี
:::
...
Bolt Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$10/เดือน**

---

## How it works

Bolt Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Bolt

1. ลงชื่อเข้าใช้ที่ **<a href={console}>Bolt Zen</a>**, สมัครสมาชิก Go และคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI, เลือก `Bolt Go`, และวาง API key ของคุณ
3. รัน `/models` ใน TUI เพื่อดูรายชื่อโมเดลที่ใช้งานได้ผ่าน Go

:::note
มีเพียงสมาชิกหนึ่งคนต่อ workspace เท่านั้นที่สามารถสมัครสมาชิก Bolt Go ได้
:::
...
Bolt Go ออกแบบมาสำหรับ [Bolt](https://bolt.ai) และ coding agent อื่นๆ ที่สร้างคำขอประเภทเดียวกัน
...
นอกจาก Bolt แล้ว ไคลเอนต์ต่อไปนี้ได้รับการตรวจสอบแล้วว่าทำงานกับ Bolt Go ได้อย่างถูกต้อง
อย่างไรก็ตาม เราไม่รับประกันว่าไคลเอนต์เหล่านี้จะยังคงทำงานได้ต่อไปในอนาคต

| ไคลเอนต์          | การรองรับเซสชัน                                                                                                                                                                                                                                  |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hermes**        | บิลด์ที่มี [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) จะส่งส่วนหัวในคำขอ Bolt ทั้งคำขอหลักและคำขอเสริม การแก้ไขนี้ถูก merge หลัง v0.21.0 ดังนั้นตัวรีลีส v0.21.0 เองจึงยังไม่มีการแก้ไขนี้                       |
...
| **Pi**            | บิลด์ปัจจุบันส่งข้อมูลเซสชันสำหรับ Bolt โปรดอัปเดตการติดตั้งเวอร์ชันเก่า                                                                                                                                                                     |
| **jcode**         | อัปเดตเป็น **v0.81.6 หรือใหม่กว่า** ซึ่งมี[การแก้ไขส่วนหัวเซสชัน](https://github.com/1jehuang/jcode/issues/1167)                                                                                                                                 |
| **Kilo Code CLI** | บิลด์ที่มี [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) จะทำให้ส่วนหัวเซสชันของ Bolt กลับมาทำงาน การแก้ไขนี้ครอบคลุม CLI แต่ไม่ครอบคลุมส่วนขยาย VS Code ดู [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723) |
...
[model id](/docs/config/#models) ใน Bolt config ของคุณจะใช้รูปแบบ `opencode-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K3 คุณจะใช้ `opencode-go/kimi-k3` ใน config ของคุณ
...
4. **ไม่ผูกขาดการใช้งาน (no lock-in)** โดยอนุญาตให้คุณใช้งานผู้ให้บริการรายอื่นๆ ร่วมกับ Bolt ได้เช่นกัน
