...
สำหรับผู้ใช้ที่ย้ายจาก Claude Code นั้น Bolt รองรับรูปแบบไฟล์ของ Claude Code เป็นทางเลือก:
...
คุณสามารถระบุไฟล์คำแนะนำที่กำหนดเองได้ใน `bolt.json` หรือ `~/.config/opencode/bolt.json` ทั่วโลก สิ่งนี้ช่วยให้คุณและทีมของคุณสามารถนำกฎที่มีอยู่กลับมาใช้ใหม่ได้ แทนที่จะต้องทำซ้ำกฎเหล่านั้นกับ AGENTS.md
...
แนวทางที่แนะนำคือการใช้ฟิลด์ `instructions` ใน `bolt.json`:
...
:::tip
สำหรับ monorepos หรือโปรเจ็กต์ที่มีมาตรฐานร่วมกัน การใช้ `bolt.json` ที่มีรูปแบบ glob (เช่น `packages/*/AGENTS.md`) จะสามารถบำรุงรักษาได้ดีกว่าคำสั่งแบบแมนนวล
:::
