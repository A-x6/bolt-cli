...
You can pass a configuration object to customize behavior. The instance still picks up your `bolt.json`, but you can override or add configuration inline:
...
If you already have a running instance of bolt, you can create a client instance to connect to it:
