...
bolt, kullanıcıların kolayca tema oluşturup özelleştirebilmesi için esnek bir JSON tabanlı tema sistemi sunar.
...
3. **Proje kök dizini** - `<project-root>/.bolt/themes/*.json`
4. **Geçerli çalışma dizini** - `./.bolt/themes/*.json`
