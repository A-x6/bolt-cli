...
bolt, GitLab CI/CD işlem hattınız veya GitLab Duo aracılığıyla GitLab iş akışınızla bütünleşir.

Her iki durumda da bolt, GitLab çalıştırıcılarınızda çalışacaktır.
...
bolt, GitLab iş akışınızla bütünleşir.
Bir yorumda `@opencode`'dan bahsedin; bolt, GitLab CI işlem hattınızdaki görevleri yürütecektir.
...
- **Güvenli**: bolt, GitLab çalıştırıcılarınızda çalışır.

---

### Yapılandırma

bolt, GitLab CI/CD işlem hattınızda çalışır; bunu ayarlamak için ihtiyacınız olacaklar:
...
- **Birleştirme isteklerini inceleme**
  ...
  bolt, birleştirme isteğini inceleyecek ve geri bildirim sağlayacaktır.
