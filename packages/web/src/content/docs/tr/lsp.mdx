...
description: Bolt, LSP sunucularınızla bütünleşir.
---

Bolt, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Bolt, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`BOLT_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
