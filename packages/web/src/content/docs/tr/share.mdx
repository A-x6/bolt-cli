...
bolt, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `bolt.json` dosyasina ekleyip Git'e commit edin.
