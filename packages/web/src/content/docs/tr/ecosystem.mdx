---
title: Ekosistem
description: Bolt ile geliştirilen projeler ve entegrasyonlar.
---

Bolt üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
Bolt ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::

Ayrıca ekosistemi ve topluluğu bir araya getiren [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) ve [bolt.cafe](https://bolt.cafe) adreslerine de göz atabilirsiniz.
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Bolt oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [bolt-devcontainers](https://github.com/athal7/bolt-devcontainers)                         | Sığ klonlar ve otomatik atanan portlarla çok dallı devcontainer izolasyonu                                                    |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile Bolt kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Bolt oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Bolt bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Bolt aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Bolt için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bolt için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, Bolt oturumlarını kontrol eden Discord botu       |
| [bolt.nvim](https://github.com/NickvanDyke/bolt.nvim)                              | API üzerine inşa edilmiş, editör farkındalıklı istemler için Neovim eklentisi   |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden Bolt için mobil öncelikli web arayüzü               |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Bolt eklentileri oluşturmak için şablon                                     |
| [bolt.nvim](https://github.com/sudo-tee/bolt.nvim)                                 | opencode için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @bolt-ai/sdk aracılığıyla Bolt kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Bolt için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [Bolt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Bolt'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Bolt tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip Bolt eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Bolt için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
