...
Dostępna usługa dostawcy jest dostępna. Jeśli otrzymasz poświadczenie dostawcy za pomocą polecenia `/connect`, będzie on dostępny po uruchomieniu bolt.
...
Oto kilka modeli, które dobrze współpracują z bolt, w kolejności. (Nie jest to lista wyczerpująca i nie jest konieczna aktualna):
...
Tutaj pełny identyfikator do `provider_id/model_id`. Na przykład, użycie [Bolt Zen](/docs/zen), przestrzeganie `opencode/gpt-5.1-codex` dla Kodeksu GPT 5.1.
...
2. Lista modeli w konstrukcji bolt.
