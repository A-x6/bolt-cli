---
title: Wstęp
description: Zacznij pracę z bolt.
---
...
- **Korzystanie z Homebrew na macOS i Linux**
  ...
  > W celu uzyskania najbardziej aktualnej wersji zalecamy korzystanie z bolt. Oficjalna formuła `brew install opencode` jest utrzymywana przez zespół Homebrew i jest aktualizowana.
...
Aby najlepiej wykorzystać działanie w systemie Windows, zalecamy włączenie [Podsystemu Windows dla systemu Linux (WSL)](/docs/windows-wsl). Zapewnia to pełną kompatybilność z funkcjami bolt.
:::
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [Bolt Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół bolt.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [bolt.ai/auth](https://bolt.ai/auth).
...
Oto [przykładowa rozmowa](https://bolt.ai/s/4XP1fce5) z bolt.

---

## Dostosuj

To tyle! Jesteś teraz profesjonalistą w korzystaniu z bolt.
