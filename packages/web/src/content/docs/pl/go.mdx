...
Bolt Go to niskokosztowa subskrypcja za **10 $/miesiąc**, która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania.

Go działa jak każdy inny dostawca w Bolt. Subskrybujesz Bolt Go i
...
Bolt Go daje Ci dostęp do tych modeli za **10 $/miesiąc**.

---

## Jak to działa

Bolt Go działa jak każdy inny dostawca w Bolt.

1. Logujesz się do **<a href={console}>Bolt Zen</a>**, subskrybujesz Go i
   kopiujesz swój klucz API.
2. Uruchamiasz komendę `/connect` w TUI, wybierasz `Bolt Go` i wklejasz
   swój klucz API.
3. Uruchom `/models` w TUI, aby zobaczyć listę modeli dostępnych w ramach Go.

:::note
Tylko jeden członek na obszar roboczy (workspace) może zasubskrybować Bolt Go.
:::
...
Bolt Go jest przeznaczony dla [Bolt](https://bolt.ai) i innych agentów kodujących,
...
Poza Bolt zweryfikowano, że poniżsi klienci działają prawidłowo
z Bolt Go. Nie gwarantujemy jednak, że będą nadal działać w przyszłości.

| Klient            | Obsługa sesji                                                                                                                                                                                                                                              |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Kompilacje zawierające [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) wysyłają nagłówek w głównych i pomocniczych żądaniach Bolt. Poprawkę scalono po wersji v0.21.0; samo to wydanie jej nie zawiera.                         |
...
| **Pi**            | Aktualne kompilacje wysyłają informacje o sesji dla Bolt. Zaktualizuj starsze instalacje.                                                                                                                                                              |
...
| **Kilo Code CLI** | Kompilacje zawierające [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) przywracają nagłówki sesji Bolt. Ta poprawka obejmuje CLI, ale nie rozszerzenie VS Code. Zobacz [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Bolt
...
4. Zapewnić **brak ograniczeń (no lock-in)**, pozwalając na korzystanie z dowolnego innego dostawcy wraz z Bolt.
