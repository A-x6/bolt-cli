...
Brama AI, możesz bezpłatnie korzystać z bolt.
...
Jeśli użytkownicy są połączeni z `/share`, połączenie jest połączone z danymi, które zostały przesłane do usług, które są udostępniane przez hosty tych użytkowników w bolt.ai.
...
**Jesteś właścicielem całości kodu źródłowego przez bolt.** Nie ma żadnych ograniczeń licencyjnych ani należących do własności.
...
Programiści muszą się zgłosić do rejestru prywatnego przed uruchomieniem bolt, aby mieć dostęp, że pakiety będą dostępne z rejestru przedsiębiorstwa.
