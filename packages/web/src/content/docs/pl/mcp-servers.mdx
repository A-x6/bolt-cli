...
Dostępny serwery MCP w [opencode Config](https://bolt.ai/docs/config/) w `mcp`. Dodaj każdy MCP z unikalną nazwą. Możesz zgłosić się do tego MCP po nazwie, pytając LLM.
...
Twoje MCP są dostępne jako narzędzie w bolt, obok narzędzi dodatkowych. Można to zrobić poprzez podłączenie bolt, jak również w innym przypadku.
