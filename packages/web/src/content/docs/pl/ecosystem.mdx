---
title: Ekosystem
description: Projekty i integracje zbudowane przy użyciu Bolt.
---

Zbiór projektów społeczności zbudowanych na Bolt.

:::note
Chcesz dodać swój projekt związany z Bolt do tej listy? Prześlij PR.
:::

Możesz również sprawdzić [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) oraz [bolt.cafe](https://bolt.cafe), społeczność agregującą ekosystem i społeczność.
...
| Nazwa                                                                                              | Opis                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatyczne uruchamianie sesji Bolt w izolowanych piaskownicach Daytona z synchronizacją git i podglądem na żywo |
...
| [bolt-devcontainers](https://github.com/athal7/bolt-devcontainers)                         | Izolacja kontenerów deweloperskich dla wielu gałęzi z płytkim klonowaniem i automatycznie przypisywanymi portami      |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Śledź użycie Bolt za pomocą Wakatime                                                                              |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Powiadomienia na pulpicie i alerty dźwiękowe dla sesji Bolt                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatyczne nazywanie sesji Zellij oparte na AI w oparciu o kontekst Bolt                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Pozwól agentom Bolt na leniwe ładowanie promptów na żądanie z odkrywaniem umiejętności i wstrzykiwaniem           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Rozszerz komendy /commands Bolt w potężny system orkiestracji ze szczegółową kontrolą przepływu                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Natywne powiadomienia systemowe dla Bolt – wiedz, kiedy zadania się zakończą                                      |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bezproblemowe drzewa robocze git dla Bolt                                                                         |
...
| Nazwa                                                                                      | Opis                                                                    |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord do sterowania sesjami Bolt, zbudowany na SDK            |
| [bolt.nvim](https://github.com/NickvanDyke/bolt.nvim)                              | Wtyczka Neovim dla promptów świadomych edytora, zbudowana na API        |
| [portal](https://github.com/hosenur/portal)                                                | Interfejs webowy mobile-first dla Bolt przez Tailscale/VPN          |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Szablon do tworzenia wtyczek Bolt                                   |
| [bolt.nvim](https://github.com/sudo-tee/bolt.nvim)                                 | Frontend Neovim dla Bolt - terminalowy agent kodujący AI            |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Dostawca Vercel AI SDK do używania Bolt przez @bolt-ai/sdk      |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplikacja Web / Desktop i rozszerzenie VS Code dla Bolt             |
| [Bolt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Wtyczka Obsidian osadzająca Bolt w interfejsie Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Otwartoźródłowa alternatywa dla Claude Cowork, napędzana przez Bolt |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Menedżer rozszerzeń Bolt z przenośnymi, izolowanymi profilami.      |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplikacja kliencka Desktop, Web, Mobile i Remote dla Bolt           |
