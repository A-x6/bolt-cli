...
- Chcą, aby Bolt pasował do wyglądu ich terminala
...
3. **Katalog główny projektu** - Zdefiniowany w `<project-root>/.bolt/themes/*.json`
4. **Bieżący katalog roboczy** - Zdefiniowany w `./.bolt/themes/*.json`
