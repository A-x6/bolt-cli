---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące bolt.
---

Funkcja udostępniania opencode umożliwia tworzenie publicznych linków do konwersacji bolt, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `bolt.json` w swoim projekcie i sprawdź w Git.
