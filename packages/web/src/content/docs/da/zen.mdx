---
title: Zen
description: Udvalgt liste over modeller leveret af Bolt.
---
...
Bolt Zen er en liste over testede og verificerede modeller leveret af Bolt-teamet.

Zen fungerer som enhver anden udbyder i Bolt. Du logger ind på Bolt Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Bolt.
:::
...
Bolt Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Bolt Zen fungerer som enhver anden udbyder i Bolt.

1. Du logger ind på **<a href={console}>Bolt Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Bolt Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Bolt-konfiguration
bruger formatet `opencode/<model-id>`. For eksempel ville du for GPT 5.5
bruge `bolt/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. Bolt bruger disse modeller til at generere sessionstitler.
...
- MiMo-V2.5 Free er tilgængelig på Bolt i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling 3.0 Flash Fin Free er tilgængelig på Bolt i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Bolt i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på Bolt i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Bolt i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Muse Spark 1.3 Contributor Free er tilgængelig på Bolt i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Bolt også.
