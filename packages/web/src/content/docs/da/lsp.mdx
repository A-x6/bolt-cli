---
title: LSP-servere
description: Bolt integreres med dine LSP-servere.
---

Bolt kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Bolt leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `BOLT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
