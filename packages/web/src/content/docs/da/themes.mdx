...
Med Bolt kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Bolt vårt eget `opencode`-tema.
...
Bolt støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
...
4. **Nuværende arbejdskatalog** - Definert i `./.bolt/themes/*.json`
