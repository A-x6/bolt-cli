...
Bolts delingsfunksjon lar deg lage offentlige lenker til dine Bolt-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruger Bolt manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `bolt.json` i prosjektet ditt og tjek inn i Git.
