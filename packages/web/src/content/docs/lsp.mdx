---
title: LSP Servers
description: Bolt integrates with your LSP servers.
---

Bolt can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Bolt comes with several built-in LSP servers for popular languages:
...
:::note
You can disable automatic LSP server downloads by setting the `BOLT_DISABLE_LSP_DOWNLOAD` environment variable to `true`.
:::
