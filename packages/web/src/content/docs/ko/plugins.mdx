---
title: 플러그인
description: Bolt를 확장하기 위해 자신만의 플러그인을 작성하세요.
---
...
1. 글로벌 구성 (`~/.config/opencode/bolt.json`)
2. 프로젝트 구성 (`bolt.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/opencode/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.bolt/plugins/`)
...
레벨: `debug`, `info`, `warn`, `error`. [SDK 문서](https://bolt.ai/docs/sdk)를 참고하세요.
