---
title: TUI
description: Korištenje korisničkog interfejsa Bolt terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Bolt pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Bolt pokreće TUI za trenutni direktorij.
...
Kada koristite Bolt TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Bolt. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Bolt. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `bolt.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Bolt čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `bolt.default`.
