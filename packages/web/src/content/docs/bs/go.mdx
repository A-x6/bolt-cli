...
Bolt Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u Bolt-u. Pretplatite se na Bolt Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Bolt.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Bolt-om.
:::
...
Bolt Go vam daje pristup ovim modelima za **$10/mjesečno**.

---

## Kako funkcioniše

Bolt Go radi kao bilo koji drugi provajder u Bolt-u.

1. Prijavite se na **<a href={console}>Bolt Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `Bolt Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Bolt Go.
:::
...
Bolt Go je osmišljen za [Bolt](https://bolt.ai) i druge agente za programiranje
...
Pored Bolt-a, potvrđeno je da sljedeći klijenti ispravno rade
s Bolt Go. Ipak, ne garantiramo da će nastaviti raditi i u budućnosti.

| Klijent           | Podrška za sesije                                                                                                                                                                                                                                          |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Buildovi koji sadrže [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) šalju zaglavlje u glavnim i pomoćnim Bolt zahtjevima. Ispravka je spojena nakon verzije v0.21.0; samo to izdanje je ne sadrži.                             |
...
| **Pi**            | Trenutni buildovi šalju informacije o sesiji za Bolt. Ažurirajte starije instalacije.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Buildovi koji sadrže [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) vraćaju Bolt zaglavlja sesije. Ova ispravka obuhvata CLI, ali ne i VS Code ekstenziju. Pogledajte [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[Model id](/docs/config/#models) u vašoj Bolt konfiguraciji
...
Napravili smo Bolt Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Bolt koristite i bilo kojeg drugog provajdera.
