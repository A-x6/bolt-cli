...
U Bolt mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Bolt koristi nasu `opencode` temu.
...
Bolt dolazi sa vise ugradenih tema.
...
- Zele da Bolt odgovara izgledu njihovog terminala
...
Bolt podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
...
3. **Korijenski direktorij projekta** - `<project-root>/.bolt/themes/*.json`
4. **Trenutni radni direktorij** - `./.bolt/themes/*.json`
