---
title: LSP serveri
description: Bolt se integriše sa vašim LSP serverima.
---

Bolt se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Bolt dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `BOLT_DISABLE_LSP_DOWNLOAD` na `true`.
:::
