...
- Effect plugins import `@bolt-ai/plugin/v2/effect`, not `@bolt-ai/core`.
- Public domain values use generated `@bolt-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@bolt-ai/plugin/v2/effect`.
