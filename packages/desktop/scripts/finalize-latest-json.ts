...
const releaseId = process.env.BOLT_RELEASE
if (!releaseId) throw new Error("BOLT_RELEASE is required")

const version = process.env.BOLT_VERSION
if (!version) throw new Error("BOLT_VERSION is required")
