export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Bolt telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
  ...
  "desktop.cli.installed.message":
    "CLI telah dipasang ke {{path}}\n\nMulakan semula terminal anda untuk menggunakan arahan 'bolt'.",
