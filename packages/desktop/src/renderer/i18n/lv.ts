export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Bolt versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
