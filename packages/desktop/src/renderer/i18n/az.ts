export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Bolt-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'bolt' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
