export const dict = {
  ...
  "desktop.updater.none.message": "آپ پہلے ہی Bolt کا تازہ ترین ورژن استعمال کر رہے ہیں۔",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt کا ورژن {{version}} ڈاؤن لوڈ ہو چکا ہے، کیا آپ اسے انسٹال کر کے دوبارہ لانچ کرنا چاہیں گے؟",
  ...
  "desktop.cli.installed.message":
    "CLI کو {{path}} پر انسٹال کر دیا گیا۔\n\n'bolt' کمانڈ استعمال کرنے کے لیے اپنا ٹرمینل دوبارہ شروع کریں۔",
