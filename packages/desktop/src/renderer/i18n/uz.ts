export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Bolt ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Boltning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'bolt' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
