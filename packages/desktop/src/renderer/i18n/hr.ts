export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Bolt. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI instaliran na {{path}}\n\nPonovno pokrenite terminal da biste koristili naredbu 'bolt'.",
