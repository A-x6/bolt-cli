export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه Bolt استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} Bolt دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
  ...
  "desktop.cli.installed.message":
    "CLI روی {{path}} نصب شد\n\nترمینال خود را مجددا راه اندازی کنید تا از دستور 'bolt' استفاده کنید.",
