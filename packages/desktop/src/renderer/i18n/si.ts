export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "ඔබ දැනටමත් Bolt හි නවතම අනුවාදය භාවිතා කරයි",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt හි {{version}} අනුවාදය බාගෙන ඇත, ඔබ එය ස්ථාපනය කර නැවත දියත් කිරීමට කැමතිද?",
  ...
  "desktop.cli.installed.message": "CLI {{path}}\n\n'bolt' විධානය භාවිතා කිරීමට ඔබගේ ටර්මිනලය නැවත ආරම්භ කරන්න.",
