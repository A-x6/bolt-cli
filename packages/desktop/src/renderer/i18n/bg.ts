export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от Bolt е изтеглена. Искате ли да я инсталирате и рестартирате?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nРестартирайте терминала си, за да използвате командата 'bolt'.",
