export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Bolt е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
