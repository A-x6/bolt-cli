export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af Bolt hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
  ...
  "desktop.cli.installed.message":
    "CLI sett upp í {{path}}\n\nEndurræstu skjáherminn til að nota 'bolt' skipunina.",
