export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини Bolt-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз Bolt зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",
  ...
  "desktop.cli.installed.message":
    "CLI ба {{path}} насб карда шудааст\n\nБарои истифодаи фармони 'bolt' терминали худро аз нав оғоз кунед.",
