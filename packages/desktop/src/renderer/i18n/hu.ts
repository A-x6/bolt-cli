export const dict = {
  ...
  "desktop.updater.none.message": "Már az Bolt legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Bolt {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'bolt' parancs használatához.",
