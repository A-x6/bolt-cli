export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Bolt is gedownload. Wil je deze installeren en Bolt opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'bolt' te gebruiken.",
