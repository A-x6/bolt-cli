export const dict = {
  ...
  "desktop.updater.none.message": "Bolt-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'bolt' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
