export const dict = {
  ...
  "desktop.updater.none.message": "आप पहले से ही Bolt का नवीनतम संस्करण उपयोग कर रहे हैं",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt का संस्करण {{version}} डाउनलोड हो गया है। क्या आप इसे इंस्टॉल करके ऐप को फिर से खोलना चाहेंगे?",
  ...
  "desktop.cli.installed.message":
    "CLI को {{path}} पर इंस्टॉल किया गया\n\n'bolt' कमांड का उपयोग करने के लिए अपना टर्मिनल पुनः आरंभ करें।",
