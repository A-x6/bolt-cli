export const dict = {
  ...
  "desktop.updater.none.message": "Χρησιμοποιείτε ήδη την πιο πρόσφατη έκδοση του Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Έχει γίνει λήψη της έκδοσης {{version}} του Bolt. Θέλετε να την εγκαταστήσετε και να επανεκκινήσετε την εφαρμογή;",
  ...
  "desktop.cli.installed.message":
    "CLI εγκατεστημένο στο {{path}}\n\nΕπανεκκινήστε το τερματικό σας για να χρησιμοποιήσετε την εντολή 'bolt'.",
