export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Bolt a fost descărcată. Vrei să o instalezi și să repornești?",
  ...
  "desktop.cli.installed.message":
    "CLI a fost instalat în {{path}}\n\nRepornește terminalul pentru a folosi comanda 'bolt'.",
