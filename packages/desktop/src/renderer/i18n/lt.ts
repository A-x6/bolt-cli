export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią Bolt versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
  ...
  "desktop.cli.installed.message":
    "CLI įdiegtas į {{path}}\n\nIš naujo paleiskite terminalą, kad galėtumėte naudoti komandą 'bolt'.",
