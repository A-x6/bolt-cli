export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የBolt ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከBolt ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
