export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Bolt. Chcete ji nainstalovat a aplikaci znovu spustit?",
  ...
  "desktop.cli.installed.message":
    "CLI nainstalováno do {{path}}\n\nRestartujte svůj terminál, abyste mohli použít příkaz 'bolt'.",
