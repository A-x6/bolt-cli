export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "ཁྱོད་ཀྱིས་ཧེ་མ་ལས་ Boltགི་ཐོན་རིམ་གསརཔ་འདི་ལག་ལེན་འཐབ་དོ།",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt གི་ཐོན་རིམ་ {{version}} ཕབ་ལེན་འབད་ཡོདཔ་ལས་ གཞི་བཙུགས་འབད་དེ་ ལོག་འགོ་བཙུགས་ནི་ཨིན་ན?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}}\n\nལུ་གཞི་བཙུགས་འབད་ནུག 'bolt' བརྡ་བཀོད་ལག་ལེན་འཐབ་ནིའི་དོན་ལུ་ ཁྱོད་རའི་ཊར་མི་ནཱལ་དེ་ལོག་འགོ་བཙུགས།",
