export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Bolt.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Bolt er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
