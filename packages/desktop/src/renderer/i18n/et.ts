export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Bolt uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
