export const dict = {
  ...
  "desktop.updater.none.message": "تسی پہلے ای Bolt دا تازہ ترین ورژن استعمال کر رئے او",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt دا ورژن {{version}} ڈاؤن لوڈ کر دتا گیا اے، کی تسی اینوں انسٹال کرنا تے دوبارہ لانچ کرنا چاہندے او؟",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} تے انسٹال کیتا گیا\n\n'bolt' کمانڈ ورتن لئی اپنے ٹرمینل نوں دوبارہ شروع کرو۔",
