export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
  ...
  "desktop.cli.installed.message":
    "CLI terinstal di {{path}}\n\nMulai ulang terminal Anda untuk menggunakan perintah 'bolt'.",
