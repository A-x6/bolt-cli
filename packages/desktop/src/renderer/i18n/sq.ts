export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Bolt është shkarkuar, dëshironi ta instaloni dhe rinisni?",
  ...
  "desktop.cli.installed.message":
    "CLI është instaluar në {{path}}\n\nRinisni terminalin tuaj për të përdorur komandën 'bolt'.",
