export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Bolt je bila prenesena, jo želite namestiti in znova zagnati?",
  ...
  "desktop.cli.installed.message":
    "CLI je nameščen v {{path}}\n\nZnova zaženite terminal, da lahko uporabite ukaz 'bolt'.",
