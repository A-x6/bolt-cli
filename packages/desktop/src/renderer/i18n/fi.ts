export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Boltn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Boltn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Boltn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'bolt'-komentoa.",
