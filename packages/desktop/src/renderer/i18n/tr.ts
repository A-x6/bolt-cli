export const dict = {
  ...
  "desktop.updater.none.message": "Bolt'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'bolt' komutunu kullanmak için terminalinizi yeniden başlatın.",
