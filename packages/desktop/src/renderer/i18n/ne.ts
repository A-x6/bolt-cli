export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "तपाईंले पहिले नै Bolt को नवीनतम संस्करण प्रयोग गरिरहनुभएको छ",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt को संस्करण {{version}} डाउनलोड गरिएको छ, के तपाइँ यसलाई स्थापना गरेर पुन: लन्च गर्न चाहनुहुन्छ?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} मा स्थापना गरियो\n\n'bolt' आदेश प्रयोग गर्न आफ्नो टर्मिनल पुन: सुरु गर्नुहोस्।",
