export const dict = {
  ...
  "desktop.updater.none.message": "މިހާރުވެސް ބޭނުން ކުރަމުންދަނީ Bolt ގެ އެންމެ ފަހުގެ ވަރޝަން އެވެ",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt ގެ ވަރޝަން {{version}} ޑައުންލޯޑް ކުރެވިއްޖެ، އިންސްޓޯލްކޮށް އަލުން ލޯންޗް ކުރަން ބޭނުން ހެއްޔެވެ؟",
  ...
  "desktop.cli.installed.message":
    "CLI އިންސްޓޯލްކޮށްފައިވަނީ {{path}} އަށެވެ\n\n'bolt' ކޮމާންޑް ބޭނުން ކުރުމަށް ޓާމިނަލް އަލުން ސްޓާޓް ކުރާށެވެ.",
