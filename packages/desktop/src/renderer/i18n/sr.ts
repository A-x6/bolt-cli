export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Bolt је преузета, да ли желите да је инсталирате и поново покренете?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nПоново покрените терминал да бисте користили команду 'bolt'.",
