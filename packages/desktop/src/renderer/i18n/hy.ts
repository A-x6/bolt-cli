export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Bolt-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Bolt-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
