export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Bolt har laddats ned. Vill du installera den och starta om programmet?",
  ...
  "desktop.cli.installed.message":
    "CLI installerat i {{path}}\n\nStarta om terminalen för att använda kommandot 'bolt'.",
