export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Bolt è stata scaricata. Vuoi installarla e riavviare l'app?",
  ...
  "desktop.cli.installed.message":
    "CLI installata in {{path}}\n\nRiavvia il terminale per utilizzare il comando 'bolt'.",
