...
const TEST_ONBOARDING = process.env.BOLT_TEST_ONBOARDING === "1"
const SIDECAR_VERSION = process.env.BOLT_SIDECAR_V2 === "1" ? "v2" : "v1"
...
const main = Effect.gen(function* () {
  ...
  process.env.BOLT_DISABLE_EMBEDDED_WEB_UI = "true"
  ...
  const loadingTask = yield* Effect.gen(function* () {
    ...
    const port = yield* Effect.gen(function* () {
      const fromEnv = process.env.BOLT_PORT
      if (fromEnv) {
