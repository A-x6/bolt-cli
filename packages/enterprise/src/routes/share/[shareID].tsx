import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@bolt-ai/sdk/v2"
import { SessionTurn } from "@bolt-ai/session-ui/session-turn"
import { SessionReview } from "@bolt-ai/session-ui/session-review"
import { DataProvider } from "@bolt-ai/session-ui/context"
import { FileComponentProvider } from "@bolt-ai/ui/context/file"
import { WorkerPoolProvider } from "@bolt-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@bolt-ai/ui/logo"
import { IconButton } from "@bolt-ai/ui/icon-button"
import { ProviderIcon } from "@bolt-ai/ui/provider-icon"
import { iife } from "@bolt-ai/core/util/iife"
import { Binary } from "@bolt-ai/core/util/binary"
import { NamedError } from "@bolt-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@bolt-ai/ui/tabs"
import { MessageNav } from "@bolt-ai/session-ui/message-nav"
import { FileSSR } from "@bolt-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@bolt-ai/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Bolt</Title>
              </Show>
              <Meta name="description" content="bolt - The AI coding agent built for the terminal." />
