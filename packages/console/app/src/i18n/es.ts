...
export const dict = {
  ...
  "notFound.logoLightAlt": "bolt logo claro",
  "notFound.logoDarkAlt": "bolt logo oscuro",
  ...
  "app.meta.description": "Bolt - El agente de codificación de código abierto.",

  "home.title": "Bolt | El agente de codificación IA de código abierto",

  "temp.title": "bolt | Agente de codificación IA creado para la terminal",
  ...
  "temp.screenshot.caption": "bolt TUI con el tema tokyonight",
  ...
  "home.what.title": "¿Qué es Bolt?",
  "home.what.body":
    "Bolt es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, Bolt es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "Bolt no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es Bolt?",
  "home.faq.a1":
    "Bolt es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso Bolt?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar Bolt?",
  "home.faq.a3.p1":
    "No necesariamente, Bolt viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, Bolt también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con Bolt?",
  "home.faq.a4.p1":
    "Sí, Bolt soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar Bolt en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! Bolt ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta Bolt?",
  "home.faq.a6":
    "Bolt es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es Bolt de código abierto?",
  "home.faq.a8.p1": "Sí, Bolt es totalmente de código abierto. El código fuente es público en",
  ...
  "zen.faq.q1": "¿Qué es Bolt Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de Bolt.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá Bolt negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, Bolt añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con Bolt, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de Bolt.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con Bolt, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "Bolt Go | Modelos de programación de bajo coste para todos",
  "go.meta.description":
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de Bolt a tantas personas como sea posible. Bolt Go es una suscripción de bajo coste de 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go cuesta 10 $/mes. Puedes usarlo con Bolt o cualquier agente.",
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a Bolt Go - {{link}}",

  "black.meta.title": "Bolt Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de Bolt Black.",
  ...
  "black.title": "Bolt Black | Precios",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de Bolt Black",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de bolt.",
  ...
  "workspace.black.subscription.message": "Estás suscrito a Bolt Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan Bolt Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan Bolt Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a Bolt Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "Bolt Go" como proveedor en tu configuración de opencode para usar los modelos Go.',
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a Bolt Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a Bolt Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "Bolt Go cuesta {{price}} y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "Bolt | Descargar",
  "download.meta.description": "Descarga Bolt para macOS, Windows y Linux",
  "download.hero.title": "Descargar Bolt Desktop",
  ...
  "download.section.extensions": "Extensiones Bolt",
  "download.section.integrations": "Integraciones Bolt",
  ...
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque Bolt funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en Bolt.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "Bolt | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a Bolt para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "Bolt opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es Bolt Enterprise?",
  "enterprise.faq.a1":
    "Bolt Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con Bolt Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. Bolt por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con Bolt Enterprise?",
  "enterprise.faq.a4":
    "Sí. Bolt no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "Bolt | Marca",
  "brand.meta.description": "Guías de marca de Bolt",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca Bolt.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "Bolt | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de Bolt",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para Bolt",
