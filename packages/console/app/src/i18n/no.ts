...
export const dict = {
  ...
  "notFound.logoLightAlt": "bolt logo lys",
  "notFound.logoDarkAlt": "bolt logo mørk",
  ...
  "app.meta.description": "Bolt - Den åpne kildekode kodingsagenten.",

  "home.title": "Bolt | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "bolt | AI-kodingsagent bygget for terminalen",
  ...
  "temp.screenshot.caption": "bolt TUI med tokyonight-tema",
  "temp.screenshot.alt": "bolt TUI med tokyonight-tema",
  "temp.logoLightAlt": "bolt logo lys",
  "temp.logoDarkAlt": "bolt logo mørk",
  ...
  "home.what.title": "Hva er Bolt?",
  "home.what.body": "Bolt er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes Bolt av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "Bolt lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er Bolt?",
  "home.faq.a1":
    "Bolt er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg Bolt?",
  ...
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men Bolt fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med Bolt?",
  "home.faq.a4.p1":
    "Ja, Bolt støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke Bolt i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! Bolt er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster Bolt?",
  "home.faq.a6":
    "Bolt er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er Bolt åpen kildekode?",
  "home.faq.a8.p1": "Ja, Bolt er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som Bolt har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "Bolt Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som Bolt har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er Bolt Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak Bolt.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan Bolt forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger Bolt til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med Bolt, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare Bolt-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med Bolt, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.title": "Bolt Go | Rimelige kodemodeller for alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe Bolt-opplevelsen til så mange som mulig. Bolt Go er et rimelig abonnement til $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go koster $10/måned. Du kan bruke det med Bolt eller hvilken som helst agent.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampanjen for {{model}} er avsluttet. Du kan fortsette å bruke modellen ved å abonnere på Bolt Go - {{link}}",

  "black.meta.title": "Bolt Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med Bolt Black-abonnementer.",
  ...
  "black.workspace.title": "Bolt Black | Velg arbeidsområde",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for Bolt Black",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Bolt Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for Bolt Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på Bolt Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "Bolt Go" som leverandør i opencode-konfigurasjonen din for å bruke Go-modeller.',
  ...
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på Bolt Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på Bolt Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.description":
    "Bolt Go koster {{price}} og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.title": "Bolt | Last ned",
  "download.meta.description": "Last ned Bolt for macOS, Windows og Linux",
  "download.hero.title": "Last ned Bolt Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble Bolt til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer Bolt med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Bolt er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om Bolt fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i Bolt.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Bolt | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt Bolt for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "Bolt opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er Bolt Enterprise?",
  "enterprise.faq.a1":
    "Bolt Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Bolt Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. Bolt lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med Bolt Enterprise?",
  "enterprise.faq.a4":
    "Ja. Bolt lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "Bolt | Merkevare",
  "brand.meta.description": "Bolt retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med Bolt-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "Bolt | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for Bolt",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for Bolt",
