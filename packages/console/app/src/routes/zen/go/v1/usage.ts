...
import { and, Database, eq, isNull } from "@bolt-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@bolt-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "Bolt Go subscription required.",
        },
      }),
      {
        status: 403,
