...
import { and, Database, eq, isNull, lt, or, sql } from "@bolt-ai/console-core/drizzle/index.js"
import { KeyTable } from "@bolt-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@bolt-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@bolt-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@bolt-ai/console-core/util/date.js"
import { Identifier } from "@bolt-ai/console-core/identifier.js"
import { Billing } from "@bolt-ai/console-core/billing.js"
import { Actor } from "@bolt-ai/console-core/actor.js"
import { WorkspaceTable } from "@bolt-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@bolt-ai/console-core/model.js"
import { Subscription } from "@bolt-ai/console-core/subscription.js"
import { BlackData } from "@bolt-ai/console-core/black.js"
import { UserTable } from "@bolt-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@bolt-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@bolt-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@bolt-ai/console-core/lite.js"
import { Resource } from "@bolt-ai/console-resource"
...
import { Workspace } from "@bolt-ai/console-core/workspace.js"
...
export async function handler(
    ...
    if (authInfo && opts.modelList === "lite" && requiresGoTrainingConsent(modelInfo.id) && !authInfo.allowTraining)
      throw new DataPolicyError(
        t("zen.api.error.trainingNotAllowed", {
          consoleGoUrl: `https://bolt.ai/workspace/${authInfo.workspaceID}/go`,
        }),
      )
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      ...
      try {
        const consoleGoUrl = `https://bolt.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://bolt.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://bolt.ai/workspace/${authInfo.workspaceID}/members`
