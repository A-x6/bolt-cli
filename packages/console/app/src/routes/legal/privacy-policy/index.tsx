...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Bolt | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Bolt privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Bolt, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <ul>
                <li>
                  ...
                  sending you information about Bolt.
                </li>
