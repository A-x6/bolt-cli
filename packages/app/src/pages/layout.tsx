...
import { base64Encode } from "@bolt-ai/core/util/encode"
...
import { Session } from "@bolt-ai/sdk/v2/client"
...
import { retry } from "@bolt-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@bolt-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://bolt.ai/desktop-feedback")}
      renderPanel={() =>
