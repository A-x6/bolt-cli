...
beforeAll(async () => {
  ...
  mock.module("@bolt-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@bolt-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@bolt-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@bolt-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
