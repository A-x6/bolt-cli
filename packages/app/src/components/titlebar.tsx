...
import { Tooltip, TooltipKeybind } from "@bolt-ai/ui/tooltip"
import { IconButtonV2 } from "@bolt-ai/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@bolt-ai/ui/v2/icon"
import { KeybindV2 } from "@bolt-ai/ui/v2/keybind-v2"
...
export function useTitlebarRightMount() {
  ...
  const sync = () => setMount(document.getElementById("bolt-titlebar-right"))
  onMount(sync)
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="bolt-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                  </div>
                </div>
                <ChannelIndicator debugTools={props.debugTools} />
              </div>
            ...
            <div
              ...
              data-tauri-drag-region
            >
              <div id="bolt-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="bolt-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator(props: { debugTools?: { visible: boolean; toggle: () => void } }) {
  const channel = import.meta.env.VITE_BOLT_CHANNEL
