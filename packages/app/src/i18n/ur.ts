export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "اس ڈسٹری بیوشن میں opencode انسٹال نہیں ہے",
  "desktop.wsl.error.boltCannotRun": "bolt انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.boltNotInstalled": "{{distro}} میں Bolt انسٹال نہیں ہے",
  ...
  "dialog.provider.bolt.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.bolt.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.boltGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.boltZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.boltZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  ...
  "dialog.plugins.empty": "bolt.json میں کنفیگر کردہ پلگ انز",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}} میں تیار ہے۔",
  "wsl.onboarding.boltReady": "Bolt تیار ہے۔",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt انسٹال نہیں ہے۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (bolt.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
