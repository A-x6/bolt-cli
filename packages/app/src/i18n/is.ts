...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Bolt",
  "Bolt-glugganum var óvænt lokað",
  "Bolt svarar ekki",
  ...
  "Uppsetning Bolt mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "bolt er ekki uppsett í þessari dreifingu",
  "bolt er uppsett en ekki var hægt að keyra það",
  "Bolt er ekki uppsett í {{distro}}",
  "Uppfærslu Bolt lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.bolt.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.bolt.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.boltGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Bolt",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.boltZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.boltZen.visit.prefix": "Heimsókn",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Bolt.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í bolt.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Bolt miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Bolt í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Bolt í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Bolt í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt er tilbúið í {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Bolt í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Bolt getur bætt við WSL netþjóni",
  ...
  "help.tabs.introduction": "Bolt Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Bolt ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Bolt teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (bolt.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Bolt styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Bolt inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Bolt skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Bolt netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Bolt",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Bolt lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Bolt fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Bolt er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Bolt ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Bolt.",
