export const dict = {
  ...
  "desktop.recovery.loadFailed": "Bolt gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Bolt ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Bolt tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Bolt gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.boltMissing": "bolt tidak dipasang dalam distro ini",
  "desktop.wsl.error.boltCannotRun": "bolt dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.boltNotInstalled": "Bolt tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Bolt selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.bolt.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.bolt.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.boltGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Bolt",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.boltZen.visit.prefix": "Layari",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Bolt.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam bolt.json",
  ...
  "dialog.server.description": "Tukar pelayan Bolt yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Bolt dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Bolt dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Bolt dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Bolt dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Bolt boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Bolt tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Bolt ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Bolt",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (bolt.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Bolt belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Bolt dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Bolt",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Bolt pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Bolt mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Bolt dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Bolt.",
