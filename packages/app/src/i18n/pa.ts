export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "اس ڈسٹرو وچ opencode انسٹال نئیں اے",
  "desktop.wsl.error.boltCannotRun": "bolt انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.boltNotInstalled": "{{distro}} وچ Bolt انسٹال نئیں اے",
  ...
  "dialog.provider.bolt.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.bolt.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.boltGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "dialog.plugins.empty": "bolt.json وچ سیٹ کیتے پلگ اِن",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}} چ تیار اے۔",
  "wsl.onboarding.boltReady": "Bolt تیار اے۔",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt انسٹال نئیں کیتا گیا",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (bolt.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
