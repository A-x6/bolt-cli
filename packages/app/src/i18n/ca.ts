export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Bolt.",
  ...
  "desktop.recovery.loadFailed": "Bolt no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Bolt s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Bolt no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Bolt ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.boltMissing": "bolt no està instal·lat en aquesta distribució",
  "desktop.wsl.error.boltCannotRun": "bolt està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.boltNotInstalled": "Bolt no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.bolt.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.bolt.tagline": "Models optimitzats fiables",
  "dialog.provider.boltGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Bolt",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.boltZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Bolt.",
  ...
  "dialog.plugins.empty": "Connectors configurats a bolt.json",
  ...
  "dialog.server.description": "Canvia a quin Bolt servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Bolt a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Bolt a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Bolt a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt està llest a {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Bolt a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Bolt pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Bolt no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Bolt.",
  ...
  "help.tabs.introduction": "Bolt L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Bolt ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Bolt.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (bolt.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Bolt encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Bolt Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Bolt dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Bolt",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Bolt al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Bolt segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Bolt.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Bolt.",
