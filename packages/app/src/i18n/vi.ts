export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "bolt chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.boltCannotRun": "bolt đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.boltNotInstalled": "Bolt chưa được cài đặt trong {{distro}}",
  ...
  "dialog.provider.bolt.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.bolt.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.boltGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Bolt cung cấp",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.boltZen.visit.prefix": "Truy cập ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " để lấy khóa API của bạn.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt đã sẵn sàng.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt chưa được cài đặt",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (bolt.json) của bạn",
