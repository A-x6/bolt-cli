...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Bolt se nije uspio učitati",
  "Prozor aplikacije Bolt neočekivano je zatvoren",
  "Bolt ne reagira",
  ...
  "Instalacija aplikacije Bolt nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "bolt nije instaliran u ovoj distribuciji",
  "bolt je instaliran, ali se ne može pokrenuti",
  "Bolt nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Bolt je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.bolt.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.bolt.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.boltGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Bolt",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.boltZen.visit.prefix": "Posjetiti",
  "provider.connect.boltZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.boltZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Bolt.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u bolt.json",
  ...
  "dialog.server.description": "Promijenite na koji se Bolt poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Bolt u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Bolt u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Bolt u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt je spreman u {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Bolt u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Bolt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Bolt može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Bolt nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Bolt.",
  ...
  "help.tabs.introduction": "Radna površina Bolt sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Bolt ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Bolt timu",
  ...
  "sidebar.gettingStarted.line1": "Bolt uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Bolt Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Bolt poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Bolt",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Bolt pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Bolt.",
