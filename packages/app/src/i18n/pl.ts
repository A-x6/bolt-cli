export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.boltCannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.boltNotInstalled": "Bolt nie jest zainstalowany w dystrybucji {{distro}}",
  ...
  "dialog.provider.bolt.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.bolt.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.boltGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.boltZen.visit.prefix": "Odwiedź ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt jest gotowy.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt nie jest zainstalowany",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (bolt.json)",
