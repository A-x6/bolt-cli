export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.boltCannotRun": "bolt quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.boltNotInstalled": "Bolt {{distro}} distribütivində quraşdırılmayıb",
  ...
  "dialog.provider.bolt.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.bolt.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.boltGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.boltZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər bolt.json-da konfiqurasiya edilib",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}}-də hazırdır.",
  "wsl.onboarding.boltReady": "Bolt hazırdır.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt quraşdırılmayıb",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (bolt.json) provayder/model adlarını yoxlayın",
