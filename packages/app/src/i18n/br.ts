export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.boltCannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.boltNotInstalled": "O Bolt não está instalado em {{distro}}",
  ...
  "dialog.provider.bolt.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.bolt.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.boltGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.boltZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.boltZen.visit.prefix": "Visite ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "O Bolt está pronto em {{distro}}.",
  "wsl.onboarding.boltReady": "O Bolt está pronto.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt não instalado",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (bolt.json)",
