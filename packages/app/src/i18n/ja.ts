export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.boltCannotRun": "boltはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.boltNotInstalled": "{{distro}}にはBoltがインストールされていません",
  ...
  "dialog.provider.bolt.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.bolt.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.boltGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Boltが提供する無料モデル",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.boltZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.boltZen.visit.prefix": " ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "bolt.jsonで設定されたプラグイン",
  ...
  "wsl.onboarding.boltReadyIn": "{{distro}}内のBoltの準備ができました。",
  "wsl.onboarding.boltReady": "Boltの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Boltがインストールされていません",
  ...
  "error.chain.checkConfig": "config (bolt.json) のプロバイダー/モデル名を確認してください",
