...
export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "此发行版中未安装 opencode",
  "desktop.wsl.error.boltCannotRun": "已安装 opencode，但无法运行",
  "desktop.wsl.error.boltNotInstalled": "{{distro}} 中未安装 Bolt",
  ...
  "dialog.provider.bolt.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.bolt.tagline": "可靠的优化模型",
  "dialog.provider.boltGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt 提供的免费模型",
  ...
  "provider.connect.boltZen.line1": "Bolt Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.boltZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.boltZen.visit.prefix": "访问 ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 bolt.json 中配置的插件",
  ...
  "wsl.onboarding.boltReadyIn": "{{distro}} 中的 Bolt 已就绪。",
  "wsl.onboarding.boltReady": "Bolt 已就绪。",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "未安装 Bolt",
  ...
  "error.chain.checkConfig": "请检查你的配置 (bolt.json) 中的 provider/model 名称",
