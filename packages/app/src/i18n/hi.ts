export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "इस डिस्ट्रो में opencode इंस्टॉल नहीं है",
  "desktop.wsl.error.boltCannotRun": "bolt इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.boltNotInstalled": "{{distro}} में Bolt इंस्टॉल नहीं है",
  ...
  "dialog.provider.bolt.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.bolt.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.boltGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  "provider.connect.boltZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.boltZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  ...
  "dialog.plugins.empty": "प्लगइन bolt.json में कॉन्फ़िगर किए गए हैं",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}} में तैयार है।",
  "wsl.onboarding.boltReady": "Bolt तैयार है।",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt स्थापित नहीं है",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (bolt.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
