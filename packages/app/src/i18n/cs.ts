export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Bolt",
  ...
  "desktop.recovery.loadFailed": "Bolt se nepodařilo načíst",
  "desktop.recovery.terminated": "Bolt okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Bolt nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Bolt instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.boltMissing": "bolt není v této distribuci nainstalováno",
  "desktop.wsl.error.boltCannotRun": "bolt je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.boltNotInstalled": "Bolt není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.bolt.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.bolt.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.boltGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezplatné modely poskytované Bolt",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  "provider.connect.boltZen.line2":
    "Pomocí jediného tlačítka API získáte přístup k modelům jako Claude, GPT, Gemini, GLM a dalším.",
  "provider.connect.boltZen.visit.prefix": "Návštěva ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Bolt.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v bolt.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Bolt serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Bolt v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Bolt v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Bolt v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt je připraveno v {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Bolt do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Bolt může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Bolt nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Bolt.",
  ...
  "help.tabs.introduction": "Bolt Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Bolt ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Bolt",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (bolt.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Bolt zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Bolt uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Bolt",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Bolt na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Bolt následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Bolt.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Bolt",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Bolt.",
