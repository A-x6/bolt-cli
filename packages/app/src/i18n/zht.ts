...
export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "此發行版中未安裝 opencode",
  "desktop.wsl.error.boltCannotRun": "已安裝 opencode，但無法執行",
  "desktop.wsl.error.boltNotInstalled": "{{distro}} 中未安裝 Bolt",
  ...
  "dialog.provider.bolt.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.bolt.tagline": "經過最佳化的可靠模型",
  "dialog.provider.boltGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt 提供的免費模型",
  ...
  "provider.connect.boltZen.line1": "Bolt Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.boltZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.boltZen.visit.prefix": "造訪 ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 bolt.json 中設定的外掛程式",
  ...
  "wsl.onboarding.boltReadyIn": "{{distro}} 中的 Bolt 已就緒。",
  "wsl.onboarding.boltReady": "Bolt 已就緒。",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "未安裝 Bolt",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (bolt.json) 中的 provider/model 名稱",
