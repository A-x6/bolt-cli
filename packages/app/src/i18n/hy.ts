export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Bolt մենյու",
  ...
  "desktop.recovery.loadFailed": "Bolt չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Bolt պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Bolt-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Bolt տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.boltMissing": "bolt-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.boltCannotRun": "bolt-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.boltNotInstalled": "Bolt տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.bolt.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.bolt.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.boltGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Bolt",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Bolt-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.boltZen.visit.prefix": "Այցելություն ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Bolt-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Bolt-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են bolt.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Bolt սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Bolt-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Bolt-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Bolt-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.boltReady": "Bolt պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Bolt-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Bolt-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Bolt-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Bolt։",
  ...
  "help.tabs.introduction": "Bolt Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Bolt թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (bolt.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Bolt-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Bolt ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Bolt սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Bolt",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Bolt տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Bolt-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Bolt-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Bolt-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Bolt-ի վերջին տարբերակը։",
