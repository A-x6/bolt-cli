export const dict = {
  ...
  "desktop.recovery.loadFailed": "Bolt መጫን አልቻለም",
  "desktop.recovery.terminated": "Bolt መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Bolt ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Boltመጫኑ አልተሳካም",
  ...
  "dialog.provider.bolt.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.bolt.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.boltGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በBolt",
  ...
  "provider.connect.boltZen.line1": "Bolt ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.boltZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.boltZen.visit.prefix": "ጎብኝ ",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በBolt ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ bolt.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Bolt አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Boltን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Bolt በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Bolt በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.boltReady": "Bolt ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Bolt በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Boltአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Bolt WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Bolt በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Bolt።",
  ...
  "help.tabs.introduction": "Bolt ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የBolt ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለBolt ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (bolt.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Bolt እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Bolt ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የBolt አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለBolt",
  ...
  "settings.general.row.appearance.description": "Boltበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Bolt ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Bolt ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Bolt ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የBolt እትም እያሄዱ ነው።",
