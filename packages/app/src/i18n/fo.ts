export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Skjøl",
  ...
  "desktop.menu.ariaLabel": "Bolt valmynd",
  ...
  "desktop.recovery.loadFailed": "Bolt miseydnaðist at heinta",
  "desktop.recovery.terminated": "Bolt vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Bolt svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Bolt uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.boltMissing": "bolt er ikki sett upp í hesi distro",
  "desktop.wsl.error.boltCannotRun": "bolt er sett upp men kundi ikki koyra",
  "desktop.wsl.error.boltNotInstalled": "Bolt er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.bolt.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.bolt.tagline": "Álítandi optimerað modell",
  "dialog.provider.boltGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Bolt",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.boltZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.boltZen.visit.prefix": "Vitja ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Bolt.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í bolt.json",
  ...
  "dialog.server.description": "Skift hvønn Bolt ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Bolt í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Bolt í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Bolt í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt er klárt í {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Bolt upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Bolt kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Bolt kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Bolt aftur.",
  ...
  "help.tabs.introduction": "Bolt Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Bolt ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Bolt toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (bolt.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Bolt stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Bolt inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Bolt Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Bolt ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Bolt",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Bolt sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Bolt fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Bolt er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Bolt byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Bolt.",
