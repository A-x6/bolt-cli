export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "bolt n'est pas installé dans cette distribution",
  "desktop.wsl.error.boltCannotRun": "bolt est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.boltNotInstalled": "Bolt n'est pas installé dans {{distro}}",
  ...
  "dialog.provider.bolt.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.bolt.tagline": "Modèles optimisés et fiables",
  "dialog.provider.boltGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.boltZen.visit.prefix": "Visitez ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt est prêt dans {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt est prêt.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt non installé",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (bolt.json)",
