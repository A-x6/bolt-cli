export const dict = {
  ...
  "desktop.menu.documentation": "Bolt hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Bolt menyusi",
  ...
  "desktop.recovery.loadFailed": "Bolt yuklanmadi",
  "desktop.recovery.terminated": "Bolt oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Bolt javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Bolt oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.boltMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.boltCannotRun": "bolt o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.boltNotInstalled": "Bolt {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Bolt yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.bolt.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.bolt.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.boltGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Bolt’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.boltZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Bolt da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Bolt da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "bolt.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Bolt serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Bolt {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Bolt yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Bolt {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Bolt-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Bolt-ni yangilang",
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}} da tayyor.",
  "wsl.onboarding.boltReady": "Bolt tayyor.",
  "wsl.onboarding.installOpencodeIn": "Bolt-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Bolt-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Bolt WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Bolt WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Bolt-ni qayta oching.",
  ...
  "help.tabs.introduction": "Bolt Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Bolt jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (bolt.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Bolt hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Bolt bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Bolt serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Bolt uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Bolt qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Bolt tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Bolt mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Bolt ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Bolt oxirgi versiyasini ishga tushiryapsiz.",
