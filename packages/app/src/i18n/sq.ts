export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Bolt",
  ...
  "desktop.menu.ariaLabel": "Menuja Bolt",
  ...
  "desktop.recovery.loadFailed": "Bolt nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Bolt u mbyll papritur",
  "desktop.recovery.unresponsive": "Bolt nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Bolt dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.boltMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.boltCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.boltNotInstalled": "Bolt nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Bolt përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.bolt.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.bolt.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.boltGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Bolt",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.boltZen.visit.prefix": "Vizitoni ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Bolt.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në bolt.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Bolt lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Bolt në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Bolt po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Bolt në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Bolt në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt është gati në {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Bolt në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Bolt të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Bolt nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Bolt ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Bolt",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (bolt.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Bolt nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Bolt brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Bolt",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Bolt",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Bolt.",
