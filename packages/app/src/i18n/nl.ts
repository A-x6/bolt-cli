export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "bolt is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.boltCannotRun": "bolt is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.boltNotInstalled": "Bolt is niet geïnstalleerd in {{distro}}",
  ...
  "dialog.provider.bolt.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.bolt.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.boltGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.boltZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.boltZen.visit.prefix": "Ga naar ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " om je API-sleutel op te halen.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt is gereed in {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt is klaar.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt niet geïnstalleerd",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (bolt.json)",
