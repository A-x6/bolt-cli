export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Bolt",
  ...
  "desktop.menu.ariaLabel": "Meniu Bolt",
  ...
  "desktop.recovery.loadFailed": "Bolt nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Bolt s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Bolt nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Bolt a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.boltMissing": "bolt nu este instalat în această distribuție",
  "desktop.wsl.error.boltCannotRun": "bolt este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.boltNotInstalled": "Bolt nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Bolt s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.bolt.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.bolt.tagline": "Modele optimizate, fiabile",
  "dialog.provider.boltGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Bolt",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.boltZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.boltZen.visit.prefix": "Vizitează",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Bolt.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în bolt.json",
  ...
  "dialog.server.description": "Schimbă serverul Bolt la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Bolt în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Bolt în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Bolt în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt este gata în {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Bolt în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Bolt să poată adăuga un server WSL",
  ...
  "help.tabs.introduction": "Bolt Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Bolt ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Bolt",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (bolt.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Bolt nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Bolt în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Bolt",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Bolt pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Bolt urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Bolt.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Bolt",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Bolt.",
