export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Bolt ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Bolt se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Bolt se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Bolt ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.boltMissing": "bolt ni nameščen v tej distribuciji",
  "desktop.wsl.error.boltCannotRun": "bolt je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.boltNotInstalled": "Bolt ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Bolt je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.bolt.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.bolt.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.boltGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Bolt",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.boltZen.visit.prefix": "Obisk ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Bolt.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v bolt.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Bolt se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Bolt ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Bolt v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Bolt ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Bolt v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Bolt v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt je pripravljen v {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Bolt v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Bolt doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Bolt ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Bolt ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Bolt",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (bolt.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Bolt še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Bolt znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Bolt",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Bolt izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Bolt sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Bolt.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Bolt",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Bolt.",
