export const dict = {
  ...
  "dialog.provider.bolt.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.bolt.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.boltGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Boltn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.boltZen.visit.prefix": "Avaa ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " ja hae API-avaimesi.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään bolt.json-tiedostossa",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt on valmis jakelussa {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Boltia ei ole asennettu",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (bolt.json) palveluntarjoajien ja mallien nimet",
  ...
  "desktop.wsl.error.boltMissing": "bolta ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.boltCannotRun": "bolt on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.boltNotInstalled": "Boltia ei ole asennettu jakeluun {{distro}}",
