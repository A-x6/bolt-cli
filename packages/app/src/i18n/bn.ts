export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Bolt ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Bolt মেনু",
  ...
  "desktop.recovery.loadFailed": "Bolt লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Bolt উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Bolt সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "Bolt ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.boltMissing": "এই ডিস্ট্রোতে opencode ইনস্টল করা নেই",
  "desktop.wsl.error.boltCannotRun": "bolt ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.boltNotInstalled": "Bolt {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "Bolt আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.provider.bolt.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.bolt.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.boltGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি Bolt দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Bolt-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.boltZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  "provider.connect.oauth.code.visit.prefix": "ভিজিট করুন",
  "provider.connect.oauth.code.visit.link": "এই লিঙ্ক",
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Bolt-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Bolt-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "bolt.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Bolt সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ Bolt চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ Bolt আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ Bolt আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "Bolt আপডেট করুন",
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.boltReady": "Bolt প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Bolt ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "Bolt ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Bolt একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  ...
  "help.tabs.introduction": "Bolt ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Bolt টিমের কাছে রিপোর্ট করুন",
  ...
  "sidebar.gettingStarted.line1": "Bolt বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Bolt সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Bolt-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Bolt কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Bolt সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Bolt থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Bolt চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি Bolt এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
