export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Документация",
  ...
  "desktop.menu.ariaLabel": "Bolt меню",
  ...
  "desktop.recovery.loadFailed": "Bolt не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът Bolt приключи неочаквано",
  "desktop.recovery.unresponsive": "Bolt не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на Bolt е неуспешно",
  "desktop.wsl.error.alreadyAdded": "{{distro}} вече е добавен",
  "desktop.wsl.error.boltMissing": "bolt не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.boltCannotRun": "bolt е инсталиран, но не може да стартира",
  "desktop.wsl.error.boltNotInstalled": "Bolt не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.provider.bolt.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.bolt.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.boltGo.tagline": "Абонамент на ниска цена за всеки",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от Bolt",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen ви дава достъп до подбран набор от надеждни оптимизирани модели за кодиращи агенти.",
  "provider.connect.boltZen.line2":
    "С един ключ API ще получите достъп до модели като Claude, GPT, Gemini, GLM и други.",
  "provider.connect.boltZen.visit.prefix": "Посетете",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "за да вземете своя ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "тази връзка",
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в Bolt.",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в bolt.json",
  ...
  "dialog.server.description": "Превключете към кой Bolt сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Проверява се Bolt в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Актуализиране на Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Актуализиране на Bolt в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Актуализирайте Bolt в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt е готов в {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt е готов.",
  "wsl.onboarding.installOpencodeIn": "Инсталирайте Bolt в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди Bolt да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "Bolt не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на Bolt ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на Bolt",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (bolt.json).",
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че Bolt все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "Bolt включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра Bolt вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за Bolt",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда Bolt на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали Bolt следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично Bolt.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на Bolt",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на Bolt.",
