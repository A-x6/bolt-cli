export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Bolt μενού",
  ...
  "desktop.recovery.loadFailed": "Bolt απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Bolt το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Bolt δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Bolt η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.boltMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.boltCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.boltNotInstalled": "Bolt δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.bolt.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.bolt.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.boltGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Bolt",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  "provider.connect.boltZen.line2":
    "Με ένα μόνο κλειδί API θα έχετε πρόσβαση σε μοντέλα όπως Claude, GPT, Gemini, GLM και άλλα.",
  "provider.connect.boltZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Bolt.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο bolt.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Bolt συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Bolt σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Bolt σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Bolt σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Bolt στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Bolt να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Bolt δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Bolt.",
  ...
  "help.tabs.introduction": "Bolt Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Bolt ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Bolt",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (bolt.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Bolt δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Bolt Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Bolt μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Bolt",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Bolt στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Bolt ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Bolt.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Bolt",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Bolt.",
