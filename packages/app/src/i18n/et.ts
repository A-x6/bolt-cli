export const dict = {
  ...
  "desktop.recovery.loadFailed": "Bolt laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Bolt aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Bolt ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Bolt installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.boltMissing": "bolt pole sellesse distrosse installitud",
  "desktop.wsl.error.boltCannotRun": "bolt on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.boltNotInstalled": "Bolt pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.bolt.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.bolt.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.boltGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Bolt",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Bolt'is.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.boltZen.visit.prefix": "Külastage ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Bolt.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis bolt.json",
  ...
  "dialog.server.description": "Lülitage, millise Bolt serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Bolt kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Bolt värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Bolt värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Bolt jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt on valmis {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Bolt asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Bolt saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Bolt ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Bolt.",
  ...
  "help.tabs.introduction": "Bolt Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Bolt ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Bolt meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (bolt.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Bolt ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Bolt sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage Bolt server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Bolt kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Bolt teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Bolt järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Bolt on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Bolt käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Bolt uusimat versiooni.",
