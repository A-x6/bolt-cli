export const dict = {
  ...
  "desktop.menu.documentation": "ເອກະສານ Bolt",
  ...
  "desktop.menu.ariaLabel": "ເມນູ Bolt",
  ...
  "desktop.recovery.loadFailed": "Bolt ລົ້ມເຫລວໃນການໂຫລດ",
  "desktop.recovery.terminated": "ປ່ອງຢ້ຽມ Bolt ຖືກປິດໂດຍບໍ່ຄາດຄິດ",
  "desktop.recovery.unresponsive": "Bolt ບໍ່ຕອບສະໜອງ",
  ...
  "desktop.wsl.error.installOpencode": "ການຕິດຕັ້ງ Bolt ລົ້ມເຫລວ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ຖືກເພີ່ມແລ້ວ",
  "desktop.wsl.error.boltMissing": "bolt ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ distro ນີ້",
  "desktop.wsl.error.boltCannotRun": "bolt ຖືກຕິດຕັ້ງແຕ່ບໍ່ສາມາດດໍາເນີນການໄດ້",
  "desktop.wsl.error.boltNotInstalled": "Bolt ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ການປັບປຸງ Bolt ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "dialog.provider.bolt.note": "ແບບທີ່ຄັດສັນມາລວມທັງ Claude, GPT, Gemini ແລະອື່ນໆ",
  "dialog.provider.bolt.tagline": "ຮູບແບບການເພີ່ມປະສິດທິພາບທີ່ເຊື່ອຖືໄດ້",
  "dialog.provider.boltGo.tagline": "ການສະໝັກໃຊ້ລາຄາຕໍ່າສຳລັບທຸກຄົນ",
  ...
  "dialog.model.unpaid.freeModels.title": "ແບບຟຣີສະໜອງໃຫ້ໂດຍ Bolt",
  ...
  "provider.connect.apiKey.description":
    "ໃສ່ລະຫັດ API {{provider}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen ໃຫ້ທ່ານເຂົ້າເຖິງຊຸດຮູບແບບການປັບແຕ່ງທີ່ໜ້າເຊື່ອຖືໄດ້ສຳລັບຕົວແທນການເຂົ້າລະຫັດ.",
  "provider.connect.boltZen.line2":
    "ດ້ວຍລະຫັດ API ດຽວເຈົ້າຈະໄດ້ຮັບການເຂົ້າເຖິງຕົວແບບເຊັ່ນ: Claude, GPT, Gemini, GLM ແລະອື່ນໆ.",
  "provider.connect.boltZen.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "ເພື່ອເກັບກຳລະຫັດ API ຂອງທ່ານ.",
  "provider.connect.oauth.code.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.oauth.code.visit.link": "ລິ້ງນີ້",
  "provider.connect.oauth.code.visit.suffix":
    "ເພື່ອເກັບກຳລະຫັດການອະນຸຍາດຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ແລະໃສ່ລະຫັດຂ້າງລຸ່ມນີ້ເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ Bolt.",
  ...
  "dialog.plugins.empty": "ປລັກອິນຖືກຕັ້ງຄ່າໃນ bolt.json",
  ...
  "dialog.server.description": "ສະຫຼັບເຊີບເວີ Bolt ທີ່ແອັບຯນີ້ເຊື່ອມຕໍ່ກັບ.",
  ...
  "wsl.onboarding.checkingOpencode": "ກຳລັງກວດສອບ Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "ກຳລັງກວດສອບ Bolt ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ກຳລັງອັບເດດ Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "ກຳລັງອັບເດດ Bolt ໃນ {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ອັບເດດ Bolt ໃນ {{distro}}.",
  "wsl.onboarding.updateOpencode": "ອັບເດດ Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt ພ້ອມແລ້ວ.",
  "wsl.onboarding.installOpencodeIn": "ຕິດຕັ້ງ Bolt ໃນ {{distro}}.",
  "wsl.onboarding.installOpencode": "ຕິດຕັ້ງ Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ Bolt ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "Bolt ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ Bolt ຄືນໃໝ່.",
  ...
  "help.tabs.introduction": "Bolt Desktop ຕອນນີ້ຖືກສ້າງຂຶ້ນໃນແຖບຕ່າງໆ.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "ເວີຊັນໃໝ່ຂອງ Bolt ({{version}}) ມີໃຫ້ຕິດຕັ້ງແລ້ວ.",
  ...
  "error.page.report.prefix": "ກະລຸນາລາຍງານຄວາມຜິດພາດນີ້ໃຫ້ທີມງານ Bolt",
  ...
  "error.chain.checkConfig": "ກວດເບິ່ງການຕັ້ງຄ່າ (bolt.json) ຜູ້ໃຫ້ບໍລິການ/ຊື່ແບບຈໍາລອງຂອງທ່ານ",
  "error.chain.mcpFailed": 'ເຊີບເວີ MCP "{{name}}" ລົ້ມເຫລວ. ໝາຍເຫດ, Bolt ບໍ່ຮອງຮັບການພິສູດຢືນຢັນ MCP ເທື່ອ.',
  ...
  "sidebar.gettingStarted.line1": "Bolt ປະກອບມີຮູບແບບຟຣີເພື່ອໃຫ້ທ່ານສາມາດເລີ່ມຕົ້ນໄດ້ທັນທີ.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ Bolt ພາຍໃນ WSL ໃນ Windows.",
  ...
  "settings.general.row.language.description": "ປ່ຽນພາສາສະແດງສໍາລັບ Bolt",
  ...
  "settings.general.row.appearance.description": "ປັບແຕ່ງວິທີ Bolt ເບິ່ງຢູ່ໃນອຸປະກອນຂອງທ່ານ",
  "settings.general.row.colorScheme.title": "ຮູບແບບສີ",
  "settings.general.row.colorScheme.description": "ເລືອກວ່າ Bolt ປະຕິບັດຕາມລະບົບ, ແສງສະຫວ່າງ, ຫຼືຮູບແບບຊ້ໍາ",
  "settings.general.row.theme.title": "ຫົວຂໍ້",
  "settings.general.row.theme.description": "ປັບແຕ່ງວິທີ Bolt ເປັນຫົວຂໍ້.",
  ...
  "settings.updates.row.startup.description": "ກວດສອບການອັບເດດໂດຍອັດຕະໂນມັດເມື່ອ Bolt ເປີດ",
  ...
  "settings.updates.toast.latest.description": "ທ່ານກຳລັງໃຊ້ Bolt ເວີຊັນຫຼ້າສຸດ.",
