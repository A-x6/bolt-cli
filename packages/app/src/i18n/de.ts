...
export const dict = {
  ...
  "dialog.provider.bolt.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.bolt.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.boltGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.boltZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In bolt.json konfigurierte Plugins",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt ist in {{distro}} bereit.",
  "wsl.onboarding.boltReady": "Bolt ist bereit.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt nicht installiert",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (bolt.json)",
  ...
  "desktop.wsl.error.boltMissing": "bolt ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.boltCannotRun": "bolt ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.boltNotInstalled": "Bolt ist in {{distro}} nicht installiert",
