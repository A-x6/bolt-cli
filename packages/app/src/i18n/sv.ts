export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "bolt är inte installerat i den här distributionen",
  "desktop.wsl.error.boltCannotRun": "bolt är installerat men kunde inte köras",
  "desktop.wsl.error.boltNotInstalled": "Bolt är inte installerat i {{distro}}",
  ...
  "dialog.provider.bolt.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.bolt.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.boltGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.boltZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.boltZen.visit.prefix": "Besök ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " för att hämta din API-nyckel.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt är redo i {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt är redo.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt är inte installerat",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (bolt.json)",
