export const dict = {
  ...
  "dialog.provider.bolt.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.bolt.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.boltGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt에서 제공하는 무료 모델",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.boltZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.boltZen.visit.prefix": "다음 ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "bolt.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(bolt.json)의 공급자/모델 이름을 확인하세요",
  ...
  "wsl.onboarding.boltReadyIn": "{{distro}}에서 Bolt를 사용할 준비가 되었습니다.",
  "wsl.onboarding.boltReady": "Bolt가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt가 설치되지 않음",
  ...
  "desktop.wsl.error.boltMissing": "이 배포판에 opencode가 설치되어 있지 않습니다",
  "desktop.wsl.error.boltCannotRun": "bolt가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.boltNotInstalled": "{{distro}}에 Bolt가 설치되어 있지 않습니다",
