export const dict = {
  ...
  "dialog.provider.bolt.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.bolt.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.boltGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Bolt",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.boltZen.visit.suffix": " per ottenere la tua chiave API.",
  ...
  "dialog.plugins.empty": "Plugin configurati in bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt è pronto in {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt è pronto.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt non installato",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (bolt.json)",
  ...
  "desktop.wsl.error.boltMissing": "bolt non è installato in questa distribuzione",
  "desktop.wsl.error.boltCannotRun": "bolt è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.boltNotInstalled": "Bolt non è installato in {{distro}}",
