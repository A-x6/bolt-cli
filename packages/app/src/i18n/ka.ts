export const dict = {
  ...
  "desktop.menu.documentation": "Bolt დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "Bolt მენიუ",
  ...
  "desktop.recovery.loadFailed": "Bolt ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "Bolt ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "Bolt არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "Bolt ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.boltMissing": "bolt არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.boltCannotRun": "bolt დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.boltNotInstalled": "Bolt არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.provider.bolt.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.bolt.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.boltGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია Bolt",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Bolt-ში.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.boltZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  "provider.connect.oauth.code.visit.prefix": "ეწვიეთ ",
  "provider.connect.oauth.code.visit.link": "ეს ბმული",
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები Bolt-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Bolt-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია bolt.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ Bolt სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია Bolt-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Bolt განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება Bolt {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt მზად არის {{distro}}-ში.",
  "wsl.onboarding.boltReady": "Bolt მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ Bolt {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ Bolt შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "Bolt ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით Bolt.",
  ...
  "help.tabs.introduction": "Bolt სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა Bolt გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (bolt.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, Bolt ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "Bolt მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "Bolt სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით Bolt სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა Bolt",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება Bolt თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა Bolt სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის Bolt თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც Bolt გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ Bolt-ის უახლეს ვერსიას.",
