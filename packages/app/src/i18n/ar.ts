export const dict = {
  ...
  "desktop.wsl.error.boltMissing": "bolt غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.boltCannotRun": "bolt مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.boltNotInstalled": "Bolt غير مثبت في {{distro}}",
  ...
  "dialog.provider.bolt.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.bolt.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.boltGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Bolt",
  ...
  "provider.connect.boltZen.line1":
    "يمنحك Bolt Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.boltZen.visit.prefix": "قم بزيارة ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في bolt.json",
  ...
  "wsl.onboarding.boltReadyIn": "Bolt جاهز في {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt جاهز.",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt غير مثبت",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (bolt.json)",
