...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Bolt įkelti nepavyko",
  "Bolt langas netikėtai užsidarė",
  "Bolt neatsako",
  ...
  "Bolt įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "bolt šiame distributyve neįdiegtas",
  "bolt įdiegtas, bet jo paleisti nepavyko",
  "Bolt neįdiegtas distributyve {{distro}}",
  "Bolt naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.bolt.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.bolt.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.boltGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Bolt modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Bolt.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.boltZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.boltZen.visit.prefix": "Aplankykite",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Bolt.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti bolt.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Bolt serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Bolt {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Bolt {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Bolt {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Bolt",
  "wsl.onboarding.boltReadyIn": "Bolt yra paruoštas {{distro}}.",
  "wsl.onboarding.boltReady": "Bolt yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Bolt į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Bolt",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Bolt galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Bolt nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Bolt ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Bolt komandai",
  ...
  "sidebar.gettingStarted.line1": "Bolt apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Bolt darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Bolt serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Bolt ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Bolt atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Bolt seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Bolt temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Bolt",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Bolt versiją.",
