export const dict = {
  ...
  "desktop.menu.documentation": "Bolt Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Bolt menýusy",
  ...
  "desktop.recovery.loadFailed": "Bolt ýükläp bilmedi",
  "desktop.recovery.terminated": "Bolt penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Bolt jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "Bolt gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.boltMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.boltCannotRun": "bolt guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.boltNotInstalled": "Bolt {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Bolt täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.bolt.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.bolt.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.boltGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Bolt tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Bolt-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.boltZen.line1":
    "Bolt Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.boltZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.boltZen.visit.prefix": "Sapar ",
  "provider.connect.boltZen.visit.link": "bolt.ai/zen",
  "provider.connect.boltZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Bolt-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Bolt-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "bolt.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Bolt serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Bolt barlanýar...",
  "wsl.onboarding.updatingOpencode": "Bolt täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Bolt täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "Bolt-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "Bolt täzeläň",
  "wsl.onboarding.boltReadyIn": "Bolt {{distro}}-de taýýar.",
  "wsl.onboarding.boltReady": "Bolt taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Bolt guruň.",
  "wsl.onboarding.installOpencode": "Bolt guruň",
  ...
  "wsl.onboarding.distroStatus.boltMissing": "Bolt gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Bolt WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Bolt bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Bolt açyň.",
  ...
  "help.tabs.introduction": "Bolt Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Bolt ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Bolt toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (bolt.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Bolt entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Bolt mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Bolt serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Bolt üçin displeý dilini üýtgediň",
  ...
  "settings.updates.row.startup.description": "Bolt işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Bolt-iň iň soňky wersiýasyny işleýärsiňiz.",
