...
import type { Config, OpencodeClient, Project } from "@bolt-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@bolt-ai/client/promise"
import type { NormalizedProviderListResponse } from "@bolt-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
