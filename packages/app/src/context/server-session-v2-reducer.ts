import type { OpenCodeEvent as BoltEvent, SessionMessageInfo, SessionPendingMessage } from "@bolt-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: BoltEvent): V2SessionReduction | undefined => {
