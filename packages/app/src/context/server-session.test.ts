...
import type { retry } from "@bolt-ai/core/util/retry"
import type { OpenCodeEvent as BoltEvent, SessionApi } from "@bolt-ai/client/promise"
import type { Message, OpencodeClient, Part, Session } from "@bolt-ai/sdk/v2/client"
...
describe("server session", () => {
  test("projects V2 session events into current and legacy message state", () => {
    ...
    const apply = (input: object) => ctx.store.applyV2(input as BoltEvent)
