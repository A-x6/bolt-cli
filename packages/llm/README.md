...
Schema-first LLM core for bolt. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@bolt-ai/llm"
import { OpenAI } from "@bolt-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@bolt-ai/llm/providers"
