...
> current private `@bolt-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@bolt-ai/ai`
...
- Secondary audience: Bolt and other durable agent runtimes
...
import { LLM } from "@bolt-ai/ai"
import { OpenAI } from "@bolt-ai/ai/providers/openai"
...
```ts
import { Message } from "@bolt-ai/ai"
...
import { LLM, Tool } from "@bolt-ai/ai"
...
Bolt and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@bolt-ai/ai/promise"
import { OpenAI } from "@bolt-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@bolt-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@bolt-ai/ai/provider"
...
@bolt-ai/ai/providers/openai
@bolt-ai/ai/providers/anthropic
@bolt-ai/ai/providers/google
...
```
...
Bolt should migrate to `generateTurn` / `streamTurn`, preserving its durable
