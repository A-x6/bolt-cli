...
import { Event } from "@bolt-ai/schema/project-directories"
import { ProjectCopy } from "@bolt-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/ProjectCopy") {}
