...
import type { EffectDrizzleSqlite } from "@bolt-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/ProjectDirectories") {}
