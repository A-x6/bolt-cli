...
import { Catalog } from "@bolt-ai/schema/catalog"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/v2/Catalog") {}
    ...
    const result: Interface = {
      ...
      model: {
        ...
        small: Effect.fn("CatalogV2.model.small")(function* (providerID) {
          ...
          if (providerID === ProviderV2.ID.bolt) {
