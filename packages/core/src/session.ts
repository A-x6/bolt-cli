...
import { ListAnchor } from "@bolt-ai/schema/session"
...
import { SessionDurable } from "@bolt-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/v2/Session") {}
