...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@bolt-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/v2/ToolRegistry") {}
