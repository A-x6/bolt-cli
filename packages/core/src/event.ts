...
import type { Data, Definition, Payload } from "@bolt-ai/schema/event"
...
import { Durable } from "@bolt-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@bolt-ai/schema/event").ID
export type { Data, Definition, Payload } from "@bolt-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/Event") {}
