...
import { define } from "@bolt-ai/plugin/v2/effect"
...
import { LocationServiceMap } from "@bolt-ai/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "bolt.json"),
              JSON.stringify({
