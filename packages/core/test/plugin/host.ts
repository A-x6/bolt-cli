import type { PluginContext } from "@bolt-ai/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@bolt-ai/sdk/v2/types"
