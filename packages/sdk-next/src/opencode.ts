import { Bolt } from "@bolt-ai/client/effect"
...
import { createEmbeddedRoutes } from "@bolt-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Bolt.create")(function* () {
  ...
  const client = yield* Bolt.make({ baseUrl: "http://bolt.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@bolt-ai/sdk-next/Bolt") {}
