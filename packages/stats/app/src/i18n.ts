...
const en = {
  "app.title": "AI Model Usage Rankings | Bolt Data",
  "app.description":
    "Explore Bolt usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Bolt Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Bolt on GitHub",
  "header.github": "GitHub",
  "header.tryBolt": "Try Bolt",
  ...
  "home.topModelsDescription": "Usage of models across Bolt.",
  ...
  "home.uniqueUsersDescription": "Daily unique Bolt users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Bolt Data",
  "lab.description":
    "Compare {{lab}} models used in Bolt, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Bolt usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Bolt",
  ...
  "lab.shareOfUsage": "{{share}} of recent Bolt usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Bolt Data",
  "model.description":
    "View {{model}} Bolt usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Bolt usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Bolt usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Bolt geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Bolt token volume.",
