export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Bolt Data",
  "app.description":
    "Esplora l'utilizzo di Bolt nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Bolt Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Bolt su GitHub",
  "header.github": "GitHub",
  "header.tryBolt": "Prova Bolt",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Bolt.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Bolt per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Bolt Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Bolt, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Bolt.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Bolt",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Bolt",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Bolt negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Bolt Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Bolt, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Bolt appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Bolt della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Bolt della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Bolt nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Bolt, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Bolt.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Bolt nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Bolt nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Bolt.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Bolt corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Bolt.",
