export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Bolt Data",
  "app.description":
    "Explore o uso do Bolt em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Bolt Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Bolt no GitHub",
  "header.github": "GitHub",
  "header.tryBolt": "Experimente o Bolt",
  ...
  "footer.homeAria": "Início do Bolt",
  ...
  "modal.title": "Newsletter do Bolt",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Bolt.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Bolt por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Bolt Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Bolt, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Bolt.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Bolt",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Bolt",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Bolt nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Bolt Data",
  "model.description":
    "Veja dados de uso de {{model}} no Bolt, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Bolt aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Bolt da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Bolt da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Bolt na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Bolt, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Bolt.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Bolt na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Bolt na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Bolt.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Bolt correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Bolt.",
