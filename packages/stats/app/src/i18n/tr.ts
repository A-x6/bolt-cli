export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Bolt Data",
  "app.description":
    "Bolt kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Bolt Data logosu",
  ...
  "header.githubAria": "GitHub'da Bolt'a yıldız ver",
  "header.github": "GitHub",
  "header.tryBolt": "Bolt'u dene",
  ...
  "footer.homeAria": "Bolt ana sayfası",
  ...
  "home.topModelsDescription": "Bolt genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Bolt kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Bolt Data",
  "lab.description":
    "Bolt'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Bolt kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Bolt'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Bolt kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Bolt token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Bolt Data",
  "model.description":
    "{{model}} için Bolt kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Bolt kullanımı görünür.",
  "model.unranked": "Geçen haftaki Bolt kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Bolt kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Bolt kullanımı yok.",
  ...
  "model.overviewDescription": "Son Bolt tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Bolt kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Bolt token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Bolt kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Bolt oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Bolt coğrafi satırı yok.",
  "model.peersDescription": "Son Bolt token hacmine göre yakındaki modeller.",
