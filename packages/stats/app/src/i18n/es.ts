export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Bolt Data",
  "app.description":
    "Explora el uso de Bolt en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Bolt Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Bolt en GitHub",
  "header.github": "GitHub",
  "header.tryBolt": "Probar Bolt",
  ...
  "footer.homeAria": "Inicio de Bolt",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Bolt.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Bolt por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Bolt Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Bolt, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Bolt.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Bolt",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Bolt",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Bolt durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Bolt Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Bolt, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Bolt aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Bolt de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Bolt de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Bolt en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Bolt, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Bolt.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Bolt durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Bolt durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Bolt.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de Bolt coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Bolt.",
