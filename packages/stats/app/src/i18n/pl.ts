export const dict = {
  "app.title": "Rankingi użycia modeli AI | Bolt Data",
  "app.description":
    "Przeglądaj użycie Bolt w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Bolt Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Bolt na GitHub",
  "header.github": "GitHub",
  "header.tryBolt": "Wypróbuj Bolt",
  ...
  "footer.homeAria": "Strona główna Bolt",
  ...
  "home.topModelsDescription": "Użycie modeli w Bolt.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Bolt według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Bolt Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Bolt, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Bolt.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Bolt",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Bolt",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Bolt z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Bolt Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Bolt, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Bolt pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Bolt z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Bolt z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Bolt w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Bolt, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Bolt.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Bolt w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Bolt w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Bolt.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Bolt nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Bolt.",
