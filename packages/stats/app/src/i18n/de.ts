export const dict = {
  "app.title": "KI-Modellnutzungs-Rankings | Bolt Data",
  "app.description":
    "Erkunde die Bolt-Nutzung über KI-Modelle hinweg, einschließlich Tokenvolumen, Rankings, Marktanteil, Tokenpreisen, Sitzungskosten, Cache-Anteil und geografischen Aufschlüsselungen.",
  "app.unfurlAlt": "Bolt Data-Wortmarke auf dunklem gemustertem Hintergrund",
  ...
  "header.githubAria": "Bolt auf GitHub mit Stern markieren",
  "header.github": "GitHub",
  "header.tryBolt": "Bolt ausprobieren",
  ...
  "footer.homeAria": "Bolt-Startseite",
  ...
  "home.topModelsDescription": "Nutzung von Modellen in Bolt.",
  ...
  "home.uniqueUsersDescription": "Täglich eindeutige Bolt-Nutzer nach Modell.",
  ...
  "lab.heroPrefix": "Erkunde {{count}} {{lab}}-Modelle, die in Bolt verwendet werden",
  ...
  "lab.shareOfUsage": "{{share}} der aktuellen Bolt-Nutzung",
  "lab.usageTitle": "{{lab}}-Tokennutzung",
  "lab.usageDescription": "Tägliches Bolt-Tokenvolumen der letzten zwei Monate.",
  ...
  "model.catalogFallback":
    "Modellfakten aus dem gemeinsamen Modellindex. Bolt-Nutzung erscheint, sobald dieses Modell Aktivität hat.",
  "model.unranked": "In der Bolt-Nutzung der letzten Woche nicht platziert",
  "model.ranked": "Rang #{{rank}} in der Bolt-Nutzung der letzten Woche",
  ...
  "model.noCurrentUsage": "Keine Bolt-Nutzung im aktuellen Datenfenster.",
  ...
  "model.overviewDescription": "Aktuelle Bolt-Tokens, eindeutige Nutzer und Marktposition.",
  "model.noSummaryTitle": "Keine Nutzungsübersicht",
  "model.noSummaryDescription": "Dieses Modell hat noch keine Bolt-Nutzungszeilen.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Tägliches Bolt-Tokenvolumen im aktuellen Zwei-Monats-Fenster.",
  ...
  "model.usersDescription": "Täglich eindeutige Bolt-Nutzer im aktuellen Zwei-Monats-Fenster.",
  ...
  "model.efficiencyDescription": "Kosten, Cache-Verhalten und durchschnittliche Bolt-Sitzungsform.",
  ...
  "model.noGeoDescription": "Keine Bolt-Geozeilen passten zu diesem Modell.",
  "model.peersDescription": "Nahe Modelle nach aktuellem Bolt-Tokenvolumen.",
