...
import { compile, emitEffectImported, emitPromise, write } from "@bolt-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "BoltEventEncoded",
              import: 'import type { BoltEventEncoded } from "@bolt-ai/protocol/groups/event"',
            },
          },
        }),
