...
- `Bolt` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `Bolt` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `Bolt` inside commands, URLs, package names, or code literals
